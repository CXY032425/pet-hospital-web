...
// node_modules/vue-cropper/dist/vue-cropper.es.js
var Y = {};
...
var A = defineComponent({
  ...
  methods: {
    ...
    touchScale(t) {
      ...
      var a = c * l;
      if (!this.touchNow) {
        if (this.touchNow = true, l > 0 ? e += Math.abs(a) : l < 0 && e > Math.abs(a) && (e -= Math.abs(a)), this.touches = t.touches, setTimeout(() => {
          this.touchNow = false;
    ...
    checkoutImgAxis(t, e, i) {
      ...
      if (this.centerBox) {
        ...
        r.x1 >= o.x1 && (s = false), r.x2 <= o.x2 && (s = false), r.y1 >= o.y1 && (s = false), r.y2 <= o.y2 && (s = false);
      }
      return s;
    }
  },
...
function U(t, e, i, s, r, o) {
  return openBlock(), createElementBlock("div", {
    ...
    t.imgs ? (openBlock(), createElementBlock("div", $, [
...
var W = N(A, [["render", U], ["__scopeId", "data-v-69939069"]]);
var F = function(t) {
