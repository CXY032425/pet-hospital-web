...
function encodeRowid(rowVal) {
  return import_xe_utils4.default.eqNull(rowVal) ? "" : encodeURIComponent(rowVal);
}
function getDeepRowIdByKey(row, rowKey) {
  return import_xe_utils4.default.get(row, rowKey);
}
function updateDeepRowKey(row, rowKey) {
  let rowid = getDeepRowIdByKey(row, rowKey);
  if (eqEmptyValue(rowid)) {
    rowid = getRowUniqueId();
    import_xe_utils4.default.set(row, rowKey, rowid);
  }
  return rowid;
}
...
var handleFieldOrColumn = ($xeTable, fieldOrColumn) => {
  if (fieldOrColumn) {
    return import_xe_utils4.default.isString(fieldOrColumn) || import_xe_utils4.default.isNumber(fieldOrColumn) ? $xeTable.getColumnByField(`${fieldOrColumn}`) : fieldOrColumn;
  }
  return null;
};
var handleRowidOrRow = ($xeTable, rowidOrRow) => {
  if (rowidOrRow) {
    const rowid = import_xe_utils4.default.isString(rowidOrRow) || import_xe_utils4.default.isNumber(rowidOrRow) ? rowidOrRow : getRowid($xeTable, rowidOrRow);
...
var countTreeExpand = (prevRow, params) => {
  let count = 1;
  if (!prevRow) {
    return count;
  }
...
// node_modules/vxe-table/es/table/src/cell.js
var { getI18n: getI18n3, getIcon: getIcon2, renderer: renderer2, formats: formats3, renderEmptyElement } = VxeUI;
function renderTitlePrefixIcon(params) {
  const { $table, column } = params;
  const titlePrefix = column.titlePrefix || column.titleHelp;
  if (titlePrefix) {
    return h("i", {
      class: ["vxe-cell-title-prefix-icon", titlePrefix.iconStatus ? `theme--${titlePrefix.iconStatus}` : "", titlePrefix.icon || getIcon2().TABLE_TITLE_PREFIX],
      onMouseenter(evnt) {
...
function renderTitleSuffixIcon(params) {
  ...
  if (titleSuffix) {
    return h("i", {
      class: ["vxe-cell-title-suffix-icon", titleSuffix.iconStatus ? `theme--${titleSuffix.iconStatus}` : "", titleSuffix.icon || getIcon2().TABLE_TITLE_SUFFIX],
      onMouseenter(evnt) {
...
function renderCellDragIcon(params) {
  ...
  return h("span", Object.assign({ key: "dg", class: ["vxe-cell--drag-handle", {
    ...
    h("i", {
      class: icon || (dragConfig ? dragConfig.rowIcon : "") || getIcon2().TABLE_DRAG_ROW
    })
  ]);
}
function renderCellBaseVNs(params, content) {
  ...
  return vns.concat(import_xe_utils6.default.isArray(content) ? content : [content]);
}
  ...
  if (columnOpts.drag && showIcon && (!visibleMethod || visibleMethod(params))) {
    if (!column.fixed && (isPeerDrag || isCrossDrag || !column.parentId)) {
      ...
      return h("span", Object.assign({ key: "dg", class: ["vxe-cell--drag-handle", {
        ...
        h("i", {
          class: icon || getIcon2().TABLE_DRAG_COLUMN
        })
      ]);
    }
  }
...
function renderHeaderCellBaseVNs(params, content) {
  const vns = [
    ...
    ...import_xe_utils6.default.isArray(content) ? content : [content],
...
var Cell = {
  ...
  renderDefaultCell(params) {
    ...
    if (isRowGroupStatus && rowGroupNode && row.isAggregate) {
      ...
      if (showTotal) {
        cellValue = getI18n3("vxe.table.rowGroupContentTotal", [cellValue, totalMethod ? totalMethod(params2) : totalValue, totalValue]);
      }
  ...
  renderRowGroupBtn(params, cellVNodes) {
    ...
    return h("div", {
      ...
      h("span", {
        ...
        h("i", {
          class: isExpand ? getIcon2().TABLE_ROW_GROUP_OPEN : getIcon2().TABLE_ROW_GROUP_CLOSE
        })
      ]),
      h("div", {
    ...
    return h("div", {
      ...
      showIcon && (lazy ? isLazyLoaded ? hasChild : hasChild || hasLazyChilds : hasChild) ? [
        h("div", Object.assign({ class: "vxe-cell--tree-btn" }, ons), [
          h("i", {
            class: isLazyLoading ? iconLoaded || getIcon2().TABLE_TREE_LOADED : isActive ? iconOpen || getIcon2().TABLE_TREE_OPEN : iconClose || getIcon2().TABLE_TREE_CLOSE
          })
        ])
      ] : null,
      h("div", {
  ...
  renderCheckboxHeader(params) {
    ...
    return renderHeaderCellBaseVNs(params, renderTitleContent(checkboxParams, [
      ...
      }], title: import_xe_utils6.default.eqNull(headerTitle) ? getI18n3("vxe.table.allTitle") : `${headerTitle || ""}` }, ons), [
        h("span", {
  ...
  renderCheckboxCellByProp(params) {
    ...
    if (!isHidden) {
      const rowid = getRowid($table, row);
      isChecked = !!updateCheckboxFlag && import_xe_utils6.default.get(row, checkField);
      ons.onClick = (evnt) => {
        if (!isDisabled && isVisible) {
          $table.triggerCheckRowEvent(evnt, params, !isChecked);
        }
  ...
  renderExpandCell(params) {
    ...
    return renderCellBaseVNs(params, [
      showIcon && (!visibleMethod || visibleMethod(params)) ? h("span", {
        ...
        h("i", {
          class: ["vxe-table--expand-btn", isLazyLoading ? iconLoaded || getIcon2().TABLE_EXPAND_LOADED : isActive ? iconOpen || getIcon2().TABLE_EXPAND_OPEN : iconClose || getIcon2().TABLE_EXPAND_CLOSE]
        })
      ]) : renderEmptyElement($table),
      defaultSlot || labelField ? h("span", {
        class: "vxe-table--expand-label"
      }, defaultSlot ? $table.callSlot(defaultSlot, params) : import_xe_utils6.default.get(row, labelField)) : renderEmptyElement($table)
    ]);
  },
      ...
      return [
        h("span", {
          ...
          h("i", {
            ...
            title: import_xe_utils6.default.eqNull(ascTitle) ? getI18n3("vxe.table.sortAsc") : `${ascTitle || ""}`,
          ...
          h("i", {
            ...
            title: import_xe_utils6.default.eqNull(descTitle) ? getI18n3("vxe.table.sortDesc") : `${descTitle || ""}`,
            onClick: allowBtn ? (evnt) => {
              evnt.stopPropagation();
...
var { getI18n: getI18n4, renderer: renderer3, renderEmptyElement: renderEmptyElement2 } = VxeUI;
var renderType = "body";
var body_default = defineComponent({
  ...
  setup(props) {
    ...
    const renderTdColumn = (seq, rowid, fixedType, isOptimizeMode, rowLevel, row, rowIndex, $rowIndex, _rowIndex, column, $columnIndex, columns, items) => {
      ...
      const isCellPadding = import_xe_utils7.default.eqNull(padding) ? allPadding === null ? cellOpts.padding : allPadding : padding;
      const cellOverflow = import_xe_utils7.default.eqNull(showOverflow) ? allShowOverflow : showOverflow;
      const showEllipsis = cellOverflow === "ellipsis";
      const showTitle = cellOverflow === "title";
      const showTooltip = cellOverflow === true || cellOverflow === "tooltip";
      const hasEllipsis = isAllOverflow || showTitle || showTooltip || showEllipsis;
      const showResizable = import_xe_utils7.default.isBoolean(column.resizable) ? column.resizable : columnOpts.resizable || allResizable;
      const isCsHeight = !!customCellHeight;
      const isRsHeight = resizeHeight > 0;
      let isDirty;
      const tdOns = {};
      const cellAlign = align || (compConf ? compConf.tableCellAlign : "") || allAlign;
      const cellVerticalAlign = import_xe_utils7.default.eqNull(verticalAlign) ? allVerticalAlign : verticalAlign;
      ...
      ], key: columnKey || scrollXLoad || scrollYLoad || columnOpts.useKey || rowOpts.useKey || columnOpts.drag ? colid : $columnIndex }, tdAttrs), { style: Object.assign({}, import_xe_utils7.default.isFunction(compCellStyle) ? compCellStyle(cellParams) : compCellStyle, import_xe_utils7.default.isFunction(cellStyle) ? cellStyle(cellParams) : cellStyle) }), tdOns), isOptimizeMode && fixedHiddenColumn ? [] : tdVNs);
    };
    const renderRows = (fixedType, isOptimizeMode, tableData, tableColumn) => {
      ...
      tableData.forEach((row, $rowIndex) => {
        ...
        rows.push(!isColLoading && (columnOpts.drag && columnDragOpts.animation) ? h(TransitionGroup, Object.assign({ name: `vxe-header--col-list${isDragColMove ? "" : "-disabled"}`, tag: "tr", class: trClass, rowid, style: rowStyle ? import_xe_utils7.default.isFunction(rowStyle) ? rowStyle(params) : rowStyle : null, key: rowKey || scrollXLoad || scrollYLoad || rowOpts.useKey || rowOpts.drag || columnOpts.drag || isRowGroupStatus || treeConfig ? rowid : $rowIndex }, trOn), {
          default: () => tdVNs
        }) : h("tr", Object.assign({ class: trClass, rowid, style: rowStyle ? import_xe_utils7.default.isFunction(rowStyle) ? rowStyle(params) : rowStyle : null, key: rowKey || scrollXLoad || scrollYLoad || rowOpts.useKey || rowOpts.drag || columnOpts.drag || isRowGroupStatus || treeConfig ? rowid : $rowIndex }, trOn), tdVNs));
        if (isExpandRow) {
          const expandOpts = computeExpandOpts.value;
          ...
          if (expandMode === "fixed") {
            ...
            const colRest = fullColumnIdData[colid] || {};
            const hasEllipsis = import_xe_utils7.default.isUndefined(showOverflow) || import_xe_utils7.default.isNull(showOverflow) ? isAllOverflow : showOverflow;
            let columnIndex = -1;
            let $columnIndex = -1;
            let _columnIndex = -1;
            if (colRest) {
...
var { renderer: renderer4, renderEmptyElement: renderEmptyElement3 } = VxeUI;
  ...
  setup(props) {
    ...
    const renderRows = (isGroup, isOptimizeMode, cols, $rowIndex) => {
      ...
      return cols.map((column, $columnIndex) => {
        ...
        const isPadding = import_xe_utils8.default.isBoolean(headerCellOpts.padding) ? headerCellOpts.padding : cellOpts.padding;
        ...
        const showResizable = import_xe_utils8.default.isBoolean(column.resizable) ? column.resizable : columnOpts.resizable || allResizable;
        const isAutoCellWidth = !column.resizeWidth && (column.minWidth === "auto" || column.width === "auto");
        let isVNPreEmptyStatus = false;
        ...
        return h("th", Object.assign(Object.assign(Object.assign({ class: [
          ...
          headerClassName ? import_xe_utils8.default.isFunction(headerClassName) ? headerClassName(cellParams) : headerClassName : "",
          headerCellClassName ? import_xe_utils8.default.isFunction(headerCellClassName) ? headerCellClassName(cellParams) : headerCellClassName : ""
        ], style: headerCellStyle ? import_xe_utils8.default.isFunction(headerCellStyle) ? headerCellStyle(cellParams) : headerCellStyle : null }, thAttrs), thOns), { key: columnKey || scrollXLoad || scrollYLoad || columnOpts.useKey || columnOpts.drag || isColGroup ? colid : $columnIndex }), [
          h("div", {
            class: ["vxe-cell", {
              "c--title": showTitle,
              "c--tooltip": showTooltip,
      ...
      return headerGroups.map((cols, $rowIndex) => {
        ...
        if (!isColLoading && columnOpts.drag && columnDragOpts.animation) {
          return h(TransitionGroup, {
            ...
            class: [
              "vxe-header--row",
              headerRowClassName ? import_xe_utils8.default.isFunction(headerRowClassName) ? headerRowClassName(params) : headerRowClassName : ""
            ],
            style: headerRowStyle ? import_xe_utils8.default.isFunction(headerRowStyle) ? headerRowStyle(params) : headerRowStyle : null
          }, {
...
var { renderer: renderer5, renderEmptyElement: renderEmptyElement4 } = VxeUI;
  ...
  setup(props) {
    ...
    const renderRows = (isOptimizeMode, tableColumn, footerTableData, row, $rowIndex, _rowIndex) => {
      ...
      return tableColumn.map((column, $columnIndex) => {
        ...
        const isColGroup = column.children && column.children.length;
        const fixedHiddenColumn = fixedType ? column.fixed !== fixedType && !isColGroup : column.fixed && overflowX;
        const isPadding = import_xe_utils9.default.isBoolean(footerCellOpts.padding) ? footerCellOpts.padding : cellOpts.padding;
        ...
        const hasEllipsis = showTitle || showTooltip || showEllipsis;
        const showResizable = import_xe_utils9.default.isBoolean(column.resizable) ? column.resizable : columnOpts.resizable || allResizable;
        const attrs = { colid };
        const tfOns = {};
        const columnIndex = colRest.index;
        const _columnIndex = colRest._index;
        ...
        return h("td", Object.assign(Object.assign(Object.assign(Object.assign({ class: ["vxe-footer--column", column.id, {
          ...
          "col--ellipsis": hasEllipsis,
          "col--current": currentColumn === column
        }, getPropClass(footerClassName, cellParams), getPropClass(footerCellClassName, cellParams)] }, attrs), { style: footerCellStyle ? import_xe_utils9.default.isFunction(footerCellStyle) ? footerCellStyle(cellParams) : footerCellStyle : null }), tfOns), { key: columnKey || scrollXLoad || scrollYLoad || columnOpts.useKey || columnOpts.drag ? column.id : $columnIndex }), [
          h("div", {
            class: ["vxe-cell", {
              "c--title": showTitle,
              "c--tooltip": showTooltip,
      ...
      return footerTableData.map((row, $rowIndex) => {
        ...
        if (!isColLoading && columnOpts.drag && columnDragOpts.animation) {
          return h(TransitionGroup, {
            ...
            class: [
              "vxe-footer--row",
              footerRowClassName ? import_xe_utils9.default.isFunction(footerRowClassName) ? footerRowClassName(rowParams) : footerRowClassName : ""
            ],
    ...
    const renderVN = () => {
      ...
      return h("div", {
        ...
        h("div", {
          ...
          fixedType ? renderEmptyElement4($xeTable) : h("div", {
            ref: refFooterXSpace,
            class: "vxe-body--x-space"
          }),
          h("table", {
...
var { getI18n: getI18n5, getIcon: getIcon3, renderEmptyElement: renderEmptyElement5 } = VxeUI;
      ...
      if (prevDragCol && dragCol) {
        if (prevDragCol !== dragCol) {
          ...
          Promise.resolve(dragEndMethod ? dragEndMethod({
            ...
            let nafIndex = -1;
            const oldAllMaps = {};
            import_xe_utils10.default.eachTree([dragColumn], (column) => {
            ...
            if (immediate) {
                ...
                if (oldAllMaps[newColumn.id]) {
                  ...
                  if (!(isCrossDrag && isSelfToChildDrag)) {
                    if (VxeUI.modal) {
                      VxeUI.modal.message({
                        status: "error",
                        content: getI18n5("vxe.error.treeDragChild")
                      });
                    }
                    return;
                  }
              ...
              const oldewMatchRest = import_xe_utils10.default.findTree(collectColumn, (item) => item.id === dragColumn.id);
              ...
              const newMatchRest = import_xe_utils10.default.findTree(collectColumn, (item) => item.id === newColumn.id);
              if (newMatchRest) {
              ...
              import_xe_utils10.default.eachTree(collectColumn, (column, index, items, path, parent) => {
                if (!parent) {
              ...
              oafIndex = import_xe_utils10.default.findIndexOf(customColumnList, (item) => item.id === dragColumn.id);
              customColumnList.splice(oafIndex, 1);
              nafIndex = import_xe_utils10.default.findIndexOf(customColumnList, (item) => item.id === newColumn.id);
        ...
        h("div", {
          ...
          h("div", {
            ...
            h("div", {
              ...
              h("span", {
                class: ["vxe-table-custom-popup--drag-tip-normal-status", getIcon3().TABLE_DRAG_STATUS_ROW]
              }),
              h("span", {
                class: ["vxe-table-custom-popup--drag-tip-sub-status", getIcon3().TABLE_DRAG_STATUS_SUB_ROW]
              }),
              h("span", {
                class: ["vxe-table-custom-popup--drag-tip-disabled-status", getIcon3().TABLE_DRAG_DISABLED]
              })
            ]),
            h("div", {
              class: "vxe-table-custom-popup--drag-tip-content"
            }, getI18n5("vxe.custom.cstmDragTarget", [dragCol && dragCol.type !== "html" ? dragCol.getTitle() : ""]))
          ])
        ])
      ]);
    };
    const renderSimplePanel = () => {
          ...
          colVNs.push(h("li", {
            ...
            h("div", {
              ...
              allowSort && ((isCrossDrag ? immediate : false) || column.level === 1) ? h("div", {
                ...
                }], title: getI18n5("vxe.custom.setting.sortHelpTip") }, isDisabled || isHidden || column.renderFixed ? {} : {
      ...
      return h("div", {
        ...
        h("div", {
          ...
          }, $xeTable.callSlot(topSlot, params)) : renderEmptyElement5($xeTable),
          defaultSlot ? h("div", {
          ...
          }, $xeTable.callSlot(bottomSlot, params)) : renderEmptyElement5($xeTable),
          renderDragTip()
        ]),
      ...
      import_xe_utils10.default.eachTree(customColumnList, (column, index, items, path, parent) => {
        ...
        if (isVisible) {
          ...
          if (allowResizable) {
            ...
            if (reMinWidth) {
              customMinWidth = import_xe_utils10.default.toNumber(import_xe_utils10.default.isFunction(reMinWidth) ? reMinWidth(resizeParams) : reMinWidth);
            }
            if (reMaxWidth) {
              customMaxWidth = import_xe_utils10.default.toNumber(import_xe_utils10.default.isFunction(reMaxWidth) ? reMaxWidth(resizeParams) : reMaxWidth);
            }
          }
          const isChecked = column.renderVisible;
          const isIndeterminate = column.halfVisible;
          ...
          trVNs.push(h("tr", {
            ...
            allowResizable ? h("td", {
              ...
              column.children && column.children.length || !(import_xe_utils10.default.isBoolean(column.resizable) ? column.resizable : columnOpts.resizable || allResizable) ? h("span", "-") : VxeUINumberInputComponent ? h(VxeUINumberInputComponent, {
                type: "integer",
                immediate: false,
            ...
            allowFixed ? h("td", {
              ...
              parent ? h("span", "-") : VxeUIRadioGroupComponent ? h(VxeUIRadioGroupComponent, {
                ...
                disabled: isDisabled || isHidden,
                options: [
                  { label: getI18n5("vxe.custom.setting.fixedLeft"), value: "left", disabled: isDisabled || isHidden || isMaxFixedColumn },
                  { label: getI18n5("vxe.custom.setting.fixedUnset"), value: "", disabled: isDisabled || isHidden },
                  { label: getI18n5("vxe.custom.setting.fixedRight"), value: "right", disabled: isDisabled || isHidden || isMaxFixedColumn }
                ],
                "onUpdate:modelValue"(value) {
...
var { getI18n: getI18n6, getIcon: getIcon4, renderer: renderer6 } = VxeUI;
...
var import_panel_default = defineComponent({
  ...
  setup(props) {
    ...
    const computeParseTypeLabel = computed(() => {
      ...
      if (type) {
        const selectItem = import_xe_utils12.default.find(typeList, (item) => type === item.value);
...
var export_panel_default = defineComponent({
  ...
  setup(props) {
    ...
    const handleOptionCheck = (column) => {
      const { storeData } = props;
      const matchObj = import_xe_utils13.default.findTree(storeData.columns, (item) => item === column);
      if (matchObj && matchObj.parent) {
        const { parent } = matchObj;
        if (parent.children && parent.children.length) {
    ...
    const allColumnEvent = () => {
      ...
      import_xe_utils13.default.eachTree(storeData.columns, (column) => {
        if (!column.disabled) {
    ...
    const getExportOption = () => {
      ...
      const expColumns = import_xe_utils13.default.searchTree(columns, (column) => column.checked, { children: "children", mapChildren: "childNodes", original: true });
                      ...
                      parameterSlot ? h("td", [
                        ...
                        h("div", {
                          ...
                          VxeUICheckboxComponent ? h(VxeUICheckboxComponent, {
                            ...
                            disabled: !isHeader,
                            title: getI18n8("vxe.export.expTitleTitle"),
                            content: getI18n8("vxe.export.expOptTitle"),
                            "onUpdate:modelValue"(value) {
...
// node_modules/vxe-table/es/table/src/table.js
var { getConfig: getConfig3, getIcon: getIcon8, getI18n: getI18n9, renderer: renderer7, formats: formats4, createEvent, globalResize: globalResize2, interceptor: interceptor2, hooks: hooks2, globalEvents: globalEvents2, GLOBAL_EVENT_KEYS, useFns, renderEmptyElement: renderEmptyElement6 } = VxeUI;
...
var table_default = defineComponent({
  ...
  setup(props, context) {
    ...
    const browseObj2 = import_xe_utils15.default.browse();
    ...
    const computeTableId = computed(() => {
      const { id } = props;
      if (id) {
        if (import_xe_utils15.default.isFunction(id)) {
    ...
    const computeValidOpts = computed(() => {
      return Object.assign({}, getConfig3().table.validConfig, props.validConfig);
    });
    ...
    const computeScrollXThreshold = computed(() => {
      ...
      if (threshold) {
        return import_xe_utils15.default.toNumber(threshold);
      }
      return 0;
    });
    ...
    const computeVirtualXOpts = computed(() => {
      return Object.assign({}, getConfig3().table.scrollX, getConfig3().table.virtualXConfig, props.scrollX, props.virtualXConfig);
    });
    const computeVirtualYOpts = computed(() => {
      return Object.assign({}, getConfig3().table.scrollY, getConfig3().table.virtualYConfig, props.scrollY, props.virtualYConfig);
    });
    const computeScrollbarOpts = computed(() => {
      return Object.assign({}, getConfig3().table.scrollbarConfig, props.scrollbarConfig);
    });
    ...
    const computeColumnOpts = computed(() => {
      return Object.assign({}, getConfig3().table.columnConfig, props.columnConfig);
    });
    const computeCurrentColumnOpts = computed(() => {
      return Object.assign({}, getConfig3().table.currentColumnConfig, props.currentColumnConfig);
    });
    const computeCellOpts = computed(() => {
      const cellOpts = Object.assign({}, getConfig3().table.cellConfig, props.cellConfig);
      if (cellOpts.height) {
        cellOpts.height = import_xe_utils15.default.toNumber(cellOpts.height);
      }
      return cellOpts;
    });
    const computeHeaderCellOpts = computed(() => {
      const headerCellOpts = Object.assign({}, getConfig3().table.headerCellConfig, props.headerCellConfig);
      const cellOpts = computeCellOpts.value;
      headerCellOpts.height = import_xe_utils15.default.toNumber(getCellHeight(headerCellOpts.height || cellOpts.height));
      return headerCellOpts;
    });
    const computeFooterCellOpts = computed(() => {
      const footerCellOpts = Object.assign({}, getConfig3().table.footerCellConfig, props.footerCellConfig);
      const cellOpts = computeCellOpts.value;
      footerCellOpts.height = import_xe_utils15.default.toNumber(getCellHeight(footerCellOpts.height || cellOpts.height));
      return footerCellOpts;
    });
    const computeRowOpts = computed(() => {
      return Object.assign({}, getConfig3().table.rowConfig, props.rowConfig);
    });
    const computeRowGroupOpts = computed(() => {
      return Object.assign({}, getConfig3().table.rowGroupConfig, props.rowGroupConfig);
    });
    const computeCurrentRowOpts = computed(() => {
      return Object.assign({}, getConfig3().table.currentRowConfig, props.currentRowConfig);
    });
    const computeRowDragOpts = computed(() => {
      return Object.assign({}, getConfig3().table.rowDragConfig, props.rowDragConfig);
    });
    const computeColumnDragOpts = computed(() => {
      return Object.assign({}, getConfig3().table.columnDragConfig, props.columnDragConfig);
    });
    const computeResizeOpts = computed(() => {
      return Object.assign({}, getConfig3().table.resizeConfig, props.resizeConfig);
    });
    const computeResizableOpts = computed(() => {
      return Object.assign({}, getConfig3().table.resizableConfig, props.resizableConfig);
    });
    const computeSeqOpts = computed(() => {
      return Object.assign({ startIndex: 0 }, getConfig3().table.seqConfig, props.seqConfig);
    });
    const computeRadioOpts = computed(() => {
      return Object.assign({}, getConfig3().table.radioConfig, props.radioConfig);
    });
    const computeCheckboxOpts = computed(() => {
      return Object.assign({}, getConfig3().table.checkboxConfig, props.checkboxConfig);
    });
    const computeTooltipOpts = computed(() => {
      return Object.assign({}, getConfig3().tooltip, getConfig3().table.tooltipConfig, props.tooltipConfig);
    });
    ...
    const computeEditOpts = computed(() => {
      return Object.assign({}, getConfig3().table.editConfig, props.editConfig);
    });
    const computeSortOpts = computed(() => {
      return Object.assign({ orders: ["asc", "desc", null] }, getConfig3().table.sortConfig, props.sortConfig);
    });
    const computeFilterOpts = computed(() => {
      return Object.assign({}, getConfig3().table.filterConfig, props.filterConfig);
    });
    const computeMouseOpts = computed(() => {
      return Object.assign({}, getConfig3().table.mouseConfig, props.mouseConfig);
    });
    const computeAreaOpts = computed(() => {
      return Object.assign({}, getConfig3().table.areaConfig, props.areaConfig);
    });
    const computeKeyboardOpts = computed(() => {
      return Object.assign({}, getConfig3().table.keyboardConfig, props.keyboardConfig);
    });
    const computeClipOpts = computed(() => {
      return Object.assign({}, getConfig3().table.clipConfig, props.clipConfig);
    });
    const computeFNROpts = computed(() => {
      return Object.assign({}, getConfig3().table.fnrConfig, props.fnrConfig);
    });
    const computeMenuOpts = computed(() => {
      return Object.assign({}, getConfig3().table.menuConfig, props.menuConfig);
    });
    ...
    const computeExportOpts = computed(() => {
      return Object.assign({}, getConfig3().table.exportConfig, props.exportConfig);
    });
    const computeImportOpts = computed(() => {
      return Object.assign({}, getConfig3().table.importConfig, props.importConfig);
    });
    const computePrintOpts = computed(() => {
      return Object.assign({}, getConfig3().table.printConfig, props.printConfig);
    });
    const computeExpandOpts = computed(() => {
      return Object.assign({}, getConfig3().table.expandConfig, props.expandConfig);
    });
    const computeTreeOpts = computed(() => {
      return Object.assign({}, getConfig3().table.treeConfig, props.treeConfig);
    });
    const computeEmptyOpts = computed(() => {
      return Object.assign({}, getConfig3().table.emptyRender, props.emptyRender);
    });
    const computeLoadingOpts = computed(() => {
      return Object.assign({}, getConfig3().table.loadingConfig, props.loadingConfig);
    });
    const computeCellOffsetWidth = computed(() => {
      return props.border ? Math.max(2, Math.ceil(reactData.scrollbarWidth / reactData.tableColumn.length)) : 1;
    });
    const computeCustomOpts = computed(() => {
      return Object.assign({}, getConfig3().table.customConfig, props.customConfig);
    });
    const computeTableRowExpandedList = computed(() => {
      ...
      if (expandColumn && rowExpandedFlag && rowGroupExpandedFlag && treeExpandedFlag) {
        if (isRowGroupStatus || treeConfig && transform) {
          import_xe_utils15.default.each(rowExpandedMaps, (row, rowid) => {
            if (visibleDataRowIdData[rowid]) {
              expandList.push(row);
            }
          });
        } else {
          return import_xe_utils15.default.values(rowExpandedMaps);
        }
      }
      return expandList;
    });
    ...
    const eqCellValue = (row1, row2, field) => {
      const val1 = import_xe_utils15.default.get(row1, field);
      const val2 = import_xe_utils15.default.get(row2, field);
      if (eqEmptyValue(val1) && eqEmptyValue(val2)) {
        return true;
      }
      if (import_xe_utils15.default.isString(val1) || import_xe_utils15.default.isNumber(val1)) {
        return "" + val1 === "" + val2;
      }
      return import_xe_utils15.default.isEqual(val1, val2);
    };
    ...
    const getCustomStorageMap = (id) => {
      ...
      const rest = import_xe_utils15.default.toStringJSON(localStorage.getItem(customStorageKey) || "");
    ...
    const setCustomStorageMap = (id, data) => {
      ...
      maps[id] = data || void 0;
      maps._v = version3;
      localStorage.setItem(customStorageKey, import_xe_utils15.default.toJSONString(maps));
    };
    const getRecoverRowMaps = (keyMaps) => {
      const { fullAllDataRowIdData } = internalData;
      const restKeys = {};
      import_xe_utils15.default.each(keyMaps, (row, rowid) => {
    ...
    const handleReserveRow = (reserveRowMap) => {
      ...
      const reserveList = [];
      import_xe_utils15.default.each(reserveRowMap, (item, rowid) => {
    ...
    const handleBodyMerge = (merges) => {
      ...
      if (merges) {
        const { handleGetRowId } = createHandleGetRowId($xeTable);
        if (!import_xe_utils15.default.isArray(merges)) {
          merges = [merges];
        }
        merges.forEach((item) => {
          ...
          if (import_xe_utils15.default.isNumber(margeRow)) {
          ...
          if (import_xe_utils15.default.isNumber(margeCol)) {
          ...
          if (mergeRowIndex > -1 && mergeColumnIndex > -1 && (rowspan || colspan)) {
            rowspan = import_xe_utils15.default.toNumber(rowspan) || 1;
            colspan = import_xe_utils15.default.toNumber(colspan) || 1;
    ...
    const handleFooterMerge = (merges) => {
      ...
      if (merges) {
        ...
        merges.forEach((item) => {
          let { row: margeRow, col: margeCol, rowspan, colspan } = item;
          const mergeRowIndex = import_xe_utils15.default.isNumber(margeRow) ? margeRow : -1;
          let mergeColumnIndex = -1;
          if (import_xe_utils15.default.isNumber(margeCol)) {
            mergeColumnIndex = margeCol;
          }
    ...
    const removeMerges = (merges, mList, rowList) => {
      ...
      if (merges) {
        ...
        merges.forEach((item) => {
          let { row, col } = item;
          if (rowList && import_xe_utils15.default.isNumber(row)) {
            row = rowList[row];
          }
          if (import_xe_utils15.default.isNumber(col)) {
            col = visibleColumn[col];
          }
          const mcIndex = import_xe_utils15.default.findIndexOf(mList, (item2) => (item2._row === row || getRowid($xeTable, item2._row) === getRowid($xeTable, row)) && (item2._col.id === col || item2._col.id === col.id));
          if (mcIndex > -1) {
    ...
    const calcTableHeight = (key) => {
      ...
      if (val) {
        if (val === "100%" || val === "auto") {
          ...
          if (isScale(val)) {
            num = Math.floor((import_xe_utils15.default.toInteger(val) || 1) / 100 * parentHeight);
          } else {
            num = import_xe_utils15.default.toNumber(val);
          }
    ...
    const handleCustomRestore = (storeData) => {
      ...
      if (resizableData || sortData || visibleData || fixedData) {
        import_xe_utils15.default.eachTree(collectColumn, (column, index, items, path, parentColumn) => {
          const colKey = column.getKey();
          if (!parentColumn) {
            if (fixedData && fixedData[colKey] !== void 0) {
              column.fixed = fixedData[colKey];
            }
            if (sortData && import_xe_utils15.default.isNumber(sortData[colKey])) {
              hasCustomSort = true;
              column.renderSortNumber = sortData[colKey];
            }
          }
          if (resizableData && import_xe_utils15.default.isNumber(resizableData[colKey])) {
            column.resizeWidth = resizableData[colKey];
          }
          if (visibleData && import_xe_utils15.default.isBoolean(visibleData[colKey])) {
            column.visible = visibleData[colKey];
          }
        });
        if (hasCustomSort) {
          collectColumn = import_xe_utils15.default.orderBy(collectColumn, "renderSortNumber");
    ...
    const cacheColumnMap = () => {
      ...
      if (isGroup) {
        import_xe_utils15.default.eachTree(collectColumn, (column, index, items, path, parentColumn, nodes) => {
    ...
    const calcColumnAutoWidth = (column, wrapperEl) => {
      ...
      if (firstCellEl && firstCellEl.parentElement) {
        ...
        leftRightPadding = Math.ceil(import_xe_utils15.default.toNumber(cellStyle.paddingLeft) + import_xe_utils15.default.toNumber(cellStyle.paddingRight));
      }
    ...
    const autoCellWidth = () => {
      ...
      pxMinList.forEach((column) => {
        const minWidth = import_xe_utils15.default.toInteger(column.minWidth);
        tWidth += minWidth;
        column.renderWidth = minWidth;
      });
      autoMinList.forEach((column) => {
        const caWidth = Math.max(60, import_xe_utils15.default.toInteger(column.renderAutoWidth));
        tWidth += caWidth;
        column.renderWidth = caWidth;
      });
      scaleMinList.forEach((column) => {
        const smWidth = Math.floor(import_xe_utils15.default.toInteger(column.minWidth) * meanWidth);
        tWidth += smWidth;
        column.renderWidth = smWidth;
      });
      scaleList.forEach((column) => {
        const sfWidth = Math.floor(import_xe_utils15.default.toInteger(column.width) * meanWidth);
        tWidth += sfWidth;
        column.renderWidth = sfWidth;
      });
      pxList.forEach((column) => {
        const pWidth = import_xe_utils15.default.toInteger(column.width);
        tWidth += pWidth;
        column.renderWidth = pWidth;
      });
      autoList.forEach((column) => {
        const aWidth = Math.max(60, import_xe_utils15.default.toInteger(column.renderAutoWidth));
        tWidth += aWidth;
        column.renderWidth = aWidth;
      });
      resizeList.forEach((column) => {
        const reWidth = import_xe_utils15.default.toInteger(column.resizeWidth);
        tWidth += reWidth;
    ...
    const calcCellAutoHeight = (rowRest, wrapperEl) => {
      ...
      for (let i = 0; i < cellElemList.length; i++) {
        ...
        const topBottomPadding = Math.ceil(import_xe_utils15.default.toNumber(tdEl.style.paddingTop) + import_xe_utils15.default.toNumber(tdEl.style.paddingBottom));
    ...
    const getOrderField = (column) => {
      ...
      return (row) => {
        let cellValue;
        if (sortBy) {
          cellValue = import_xe_utils15.default.isFunction(sortBy) ? sortBy({ row, column }) : import_xe_utils15.default.get(row, sortBy);
        } else {
          cellValue = tableMethods.getCellLabel(row, column);
        }
        if (!sortType || sortType === "auto") {
          return isNaN(cellValue) ? cellValue : import_xe_utils15.default.toNumber(cellValue);
        } else if (sortType === "number") {
          return import_xe_utils15.default.toNumber(cellValue);
        } else if (sortType === "string") {
          return import_xe_utils15.default.toValueString(cellValue);
        }
        return cellValue;
      };
    };
    ...
    const updateAfterDataIndex = () => {
      ...
      if (treeConfig) {
        const { handleGetRowId } = createHandleGetRowId($xeTable);
        import_xe_utils15.default.eachTree(afterTreeFullData, (row, index, items, path) => {
          const rowid = handleGetRowId(row);
          const rowRest = fullAllDataRowIdData[rowid];
    ...
    const handleVirtualTreeToList = () => {
      ...
      if (treeConfig && treeOpts.transform) {
        const childrenField = treeOpts.children || treeOpts.childrenField;
        import_xe_utils15.default.eachTree(internalData.afterTreeFullData, (row, index, items, path, parentRow) => {
          const rowid = handleGetRowId(row);
        ...
        import_xe_utils15.default.eachTree(internalData.afterGroupFullData, (row, index, items, path, parentRow) => {
          const rowid = handleGetRowId(row);
          const parentRowid = handleGetRowId(parentRow);
    ...
    const updateAfterFullData = () => {
      ...
      if (!allRemoteFilter || !allRemoteSort) {
        ...
        if (sortMultiple && chronological && orderColumns.length > 1) {
          orderColumns = import_xe_utils15.default.orderBy(orderColumns, "sortTime");
        }
        if (!allRemoteFilter && filterColumns.length) {
          const handleFilter = (row) => {
            return filterColumns.every(({ column, valueList, itemList }) => {
              ...
              return valueList.indexOf(import_xe_utils15.default.get(row, column.field)) > -1;
            });
          };
          if (isRowGroupStatus) {
            tableTree = import_xe_utils15.default.searchTree(tableFullGroupData, handleFilter, {
              original: true,
              isEvery: true,
            ...
            tableTree = import_xe_utils15.default.searchTree(tableFullTreeData, handleFilter, {
              original: true,
              isEvery,
          ...
          if (isRowGroupStatus) {
            tableTree = import_xe_utils15.default.searchTree(tableFullGroupData, () => true, {
              original: true,
              isEvery: true,
              children: rowGroupOpts.mapChildrenField,
              mapChildren: rowGroupOpts.childrenField
            ...
            tableTree = import_xe_utils15.default.searchTree(tableFullTreeData, () => true, {
              original: true,
              isEvery,
              children: mapChildrenField,
              mapChildren: childrenField
        ...
        if (!allRemoteSort && orderColumns.length) {
          if (isRowGroupStatus) {
            if (allSortMethod) {
              ...
              tableTree = import_xe_utils15.default.isArray(sortRests) ? sortRests : tableTree;
            } else {
              const treeList = import_xe_utils15.default.toTreeArray(tableTree, {
                key: rowGroupOpts.rowField,
                parentKey: rowGroupOpts.parentField,
                children: rowGroupOpts.mapChildrenField
              });
              tableTree = import_xe_utils15.default.toArrayTree(import_xe_utils15.default.orderBy(treeList, orderColumns.map(({ column, order }) => [getOrderField(column), order])), {
                key: rowGroupOpts.rowField,
                parentKey: rowGroupOpts.parentField,
            ...
            if (allSortMethod) {
              ...
              tableData = import_xe_utils15.default.isArray(sortRests) ? sortRests : tableData;
            } else {
              tableData = import_xe_utils15.default.orderBy(tableData, orderColumns.map(({ column, order }) => [getOrderField(column), order]));
            }
            tableTree = tableData;
          }
        }
      ...
      containerList.forEach((name, index) => {
        ...
        layoutList.forEach((layout) => {
          ...
          if (layout === "header") {
            ...
            if (tableElem) {
              tableElem.style.width = tWidth ? `${tWidth}px` : "";
              tableElem.style.paddingRight = osbWidth && fixedType && (browseObj2.firefox || browseObj2.safari) ? `${osbWidth}px` : "";
            }
    ...
    const handleDefaultSort = () => {
      ...
      if (sortConfig) {
        ...
        if (defaultSort) {
          if (!import_xe_utils15.default.isArray(defaultSort)) {
    ...
    const handleCheckedCheckboxRow = (rows, value, isForce) => {
      if (rows && !import_xe_utils15.default.isArray(rows)) {
        rows = [rows];
      }
    ...
    const handleCheckedAllCheckboxRow = (checked, isForce) => {
      ...
      if (checkField) {
        const checkValFn = (row) => {
          if (isForce || (!checkMethod || checkMethod({ $table: $xeTable, row }))) {
            ...
            import_xe_utils15.default.set(row, checkField, checked);
          }
          if ((treeConfig || isRowGroupStatus) && indeterminateField) {
            import_xe_utils15.default.set(row, indeterminateField, false);
          }
        };
        if (treeConfig || isRowGroupStatus) {
          import_xe_utils15.default.eachTree(afterFullData, checkValFn, { children: childrenField });
        } else {
        ...
        if (isRowGroupStatus) {
          if (checked) {
            import_xe_utils15.default.eachTree(afterGroupFullData, (row) => {
              if (isForce || (!checkMethod || checkMethod({ $table: $xeTable, row }))) {
                const rowid = handleGetRowId(row);
          ...
          if (checked) {
            import_xe_utils15.default.eachTree(afterTreeFullData, (row) => {
              if (isForce || (!checkMethod || checkMethod({ $table: $xeTable, row }))) {
                const rowid = handleGetRowId(row);
                selectRowMaps[rowid] = row;
              }
      ...
      if (reserve) {
        if (checked) {
          import_xe_utils15.default.each(selectRowMaps, (row, rowid) => {
            checkboxReserveRowMap[rowid] = row;
          });
        } else {
    ...
    const handleDefaultTreeExpand = () => {
      ...
      if (treeConfig) {
        ...
        if (expandAll) {
          ...
          const rowkey = getRowkey($xeTable);
          expandRowKeys.forEach((rowid) => {
            const matchObj = import_xe_utils15.default.findTree(tableFullData, (item) => rowid === import_xe_utils15.default.get(item, rowkey), { children: childrenField });
            if (matchObj) {
      ...
      return new Promise((resolve) => {
        if (loadMethod) {
          ...
          Promise.resolve(loadMethod({ $table: $xeTable, row })).then((childRecords) => {
            ...
            if (!import_xe_utils15.default.isArray(childRecords)) {
              childRecords = [];
            }
            if (childRecords) {
    ...
    const computeScrollLoad = () => {
      return nextTick().then(() => {
        ...
        if (scrollXLoad) {
          ...
          const offsetXSize = Math.max(0, virtualXOpts.oSize ? import_xe_utils15.default.toNumber(virtualXOpts.oSize) : 0);
          scrollXStore.preloadSize = import_xe_utils15.default.toNumber(virtualXOpts.preSize);
        ...
        if (scrollYLoad) {
          const offsetYSize = Math.max(0, virtualYOpts.oSize ? import_xe_utils15.default.toNumber(virtualYOpts.oSize) : 0);
          scrollYStore.preloadSize = import_xe_utils15.default.toNumber(virtualYOpts.preSize);
    ...
    const handleUpdateRowGroup = (groupFields) => {
      reactData.rowGroupList = groupFields ? (import_xe_utils15.default.isArray(groupFields) ? groupFields : [groupFields]).map((field) => {
        return {
          field
        };
      }) : [];
    ...
    const handleGroupData = (list, rowGroups) => {
      ...
      if (rowGroups) {
        ...
        if (rgItem && rowField && parentField && childrenField && mapChildrenField) {
          ...
          const rowkey = getRowkey($xeTable);
          list.forEach((row) => {
            const cellValue = groupColumn ? $xeTable.getCellLabel(row, groupColumn) : import_xe_utils15.default.get(row, groupField);
            const groupValue = import_xe_utils15.default.eqNull(cellValue) ? "" : cellValue;
          ...
          import_xe_utils15.default.objectEach(groupMaps, (childList, groupValue) => {
    ...
    const loadTableData = (datas, isReset) => {
      ...
      if (treeConfig) {
        if (transform) {
          ...
          treeData = import_xe_utils15.default.toArrayTree(fullData, {
    ...
    const handleUpdateColumn = () => {
      const columnList = import_xe_utils15.default.orderBy(internalData.collectColumn, "renderSortNumber");
    ...
    const parseColumns = (isReset) => {
      ...
      if (isGroup) {
        ...
        import_xe_utils15.default.eachTree(collectColumn, (column, index, items, path, parentColumn) => {
          ...
          if (isColGroup) {
            column.visible = !!import_xe_utils15.default.findTree(column.children, (subColumn) => hasChildrenList(subColumn) ? false : subColumn.visible);
    ...
    const handleBaseTreeExpand = (rows, expanded) => {
      ...
      if (accordion) {
        ...
        const matchObj = import_xe_utils15.default.findTree(tableFullTreeData, (item) => item === validRows[0], { children: childrenField });
        if (matchObj) {
    ...
    const handleRowGroupBaseExpand = (rows, expanded) => {
      ...
      if (mapChildrenField) {
        if (accordion) {
          validRows = validRows.length ? [validRows[validRows.length - 1]] : [];
          const matchObj = import_xe_utils15.default.findTree(tableFullGroupData, (item) => getRowid($xeTable, item) === getRowid($xeTable, validRows[0]), { children: mapChildrenField });
          if (matchObj) {
            matchObj.items.forEach((item) => {
              const rowid = handleGetRowId(item);
    ...
    const updateRowExpandStyle = () => {
      ...
      if (expandColumn && mode === "fixed") {
        ...
        if (rowExpandEl && bodyScrollElem) {
          ...
          import_xe_utils15.default.arrayEach(rowExpandEl.children, (reEl) => {
            const expandEl = reEl;
    ...
    tableMethods = {
      ...
      setRow(rows, record) {
        if (rows && record) {
          let rest = rows;
          if (!import_xe_utils15.default.isArray(rows)) {
            rest = [rows];
          }
          const rowkey = getRowkey($xeTable);
          rest.forEach((row) => {
            const rowid = getRowid($xeTable, row);
            const newRecord = import_xe_utils15.default.clone(Object.assign({}, record), true);
            import_xe_utils15.default.set(newRecord, rowkey, rowid);
      ...
      reloadRow(row, record, field) {
        ...
        if (keepSource) {
          ...
          if (oRow && row) {
            if (field) {
              const newValue = import_xe_utils15.default.clone(import_xe_utils15.default.get(record || row, field), true);
              import_xe_utils15.default.set(row, field, newValue);
              import_xe_utils15.default.set(oRow, field, newValue);
            } else {
              const rowkey = getRowkey($xeTable);
              const rowid = getRowid($xeTable, row);
              const newRecord = import_xe_utils15.default.clone(Object.assign({}, record), true);
              import_xe_utils15.default.set(newRecord, rowkey, rowid);
              import_xe_utils15.default.destructuring(oRow, Object.assign(row, newRecord));
            }
          }
      ...
      loadTreeChildren(row, childRecords) {
        ...
        return tableMethods.createData(childRecords).then((rows) => {
          if (keepSource) {
            const rowid = getRowid($xeTable, row);
            const matchObj = import_xe_utils15.default.findTree(tableSourceData, (item) => rowid === getRowid($xeTable, item), { children: childrenField });
            if (matchObj) {
              matchObj.item[childrenField] = import_xe_utils15.default.clone(rows, true);
            }
            rows.forEach((childRow) => {
              const rowid2 = getRowid($xeTable, childRow);
              sourceDataRowIdData[rowid2] = import_xe_utils15.default.clone(childRow, true);
            });
          }
          import_xe_utils15.default.eachTree(rows, (childRow, index, items, path, parentItem, nodes) => {
          ...
          if (transform) {
            row[mapChildrenField] = import_xe_utils15.default.clone(rows, false);
          }
          updateAfterDataIndex();
          return rows;
        });
       ...
       */
      loadColumn(columns) {
        const collectColumn = import_xe_utils15.default.mapTree(columns, (column) => reactive(cell_default.createColumn($xeTable, column)));
       ...
       */
      createRow(records) {
        const isArr = import_xe_utils15.default.isArray(records);
        if (!isArr) {
          records = [records || {}];
        }
      ...
      revertData(rows, field) {
        ...
        if (rows) {
          ...
          targetRows = import_xe_utils15.default.toArray($xeTable.getUpdateRecords());
        }
        let reDelFlag = false;
          ...
          targetRows.forEach((item) => {
            ...
            if (rowRest) {
              ...
              if (!$xeTable.isInsertByRow(row)) {
                ...
                if (oRow && row) {
                  if (field) {
                    import_xe_utils15.default.set(row, field, import_xe_utils15.default.clone(import_xe_utils15.default.get(oRow, field), true));
                  } else {
                    import_xe_utils15.default.destructuring(row, import_xe_utils15.default.clone(oRow, true));
                  }
      ...
      clearData(rows, field) {
        ...
        if (!arguments.length) {
          rows = tableFullData;
        } else if (rows && !import_xe_utils15.default.isArray(rows)) {
          rows = [rows];
        }
        if (field) {
          rows.forEach((row) => import_xe_utils15.default.set(row, field, null));
        } else {
          rows.forEach((row) => {
      ...
      isUpdateByRow(rowidOrRow, field) {
        ...
        if (keepSource) {
          const rowid = import_xe_utils15.default.isString(rowidOrRow) || import_xe_utils15.default.isNumber(rowidOrRow) ? rowidOrRow : getRowid($xeTable, rowidOrRow);
      ...
      getColumns(columnIndex) {
        const { visibleColumn } = internalData;
        return import_xe_utils15.default.isUndefined(columnIndex) ? visibleColumn.slice(0) : visibleColumn[columnIndex];
      },
      /**
       * 根据列获取列的唯一主键
       */
      ...
      moveColumnTo(fieldOrColumn, targetFieldOrColumn, options) {
        ...
        let defPos = "left";
        if (import_xe_utils15.default.isNumber(targetFieldOrColumn)) {
      ...
      moveRowTo(rowidOrRow, targetRowidOrRow, options) {
        ...
        if (import_xe_utils15.default.isNumber(targetRowidOrRow)) {
      ...
      getData(rowIndex) {
        ...
        return import_xe_utils15.default.isUndefined(rowIndex) ? tableSynchData.slice(0) : tableSynchData[rowIndex];
      },
      /**
       * 用于多选行，获取已选中的数据
       */
        ...
        if (updateCheckboxFlag) {
          if (checkField) {
            if (treeConfig) {
              ...
              rowList = import_xe_utils15.default.filterTree(currTableData, (row) => import_xe_utils15.default.get(row, checkField), { children: transform ? mapChildrenField : childrenField });
            } else {
              const currTableData = isFull ? tableFullData : afterFullData;
              rowList = currTableData.filter((row) => import_xe_utils15.default.get(row, checkField));
            }
          } else {
            const currMaps = isFull || treeConfig && !transform ? fullDataRowIdData : afterFullRowMaps;
            import_xe_utils15.default.each(selectCheckboxMaps, (row, rowid) => {
              if (currMaps[rowid]) {
      ...
      getTreeRowChildren(rowOrRowid) {
        ...
        if (rowOrRowid && treeConfig) {
          let rowid;
          if (import_xe_utils15.default.isString(rowOrRowid)) {
            rowid = rowOrRowid;
          } else {
      ...
      getRowById(cellValue) {
        const { fullAllDataRowIdData } = internalData;
        const rowid = import_xe_utils15.default.eqNull(cellValue) ? "" : encodeURIComponent(cellValue || "");
      ...
      getFullData() {
        ...
        if (treeConfig) {
          ...
          const childrenField = treeOpts.children || treeOpts.childrenField;
          if (transform) {
            return import_xe_utils15.default.toArrayTree(import_xe_utils15.default.toTreeArray(tableFullTreeData, {
              children: mapChildrenField
            }), {
              key: rowField,
              parentKey: parentField,
      ...
      setColumnFixed(fieldOrColumn, fixed) {
        let status = false;
        const cols = import_xe_utils15.default.isArray(fieldOrColumn) ? fieldOrColumn : [fieldOrColumn];
        const columnOpts = computeColumnOpts.value;
        const isMaxFixedColumn = computeIsMaxFixedColumn.value;
        for (let i = 0; i < cols.length; i++) {
          ...
          if (targetColumn && targetColumn.fixed !== fixed) {
            ...
            import_xe_utils15.default.eachTree([targetColumn], (column2) => {
              column2.fixed = fixed;
            });
      ...
      setColumnWidth(fieldOrColumn, width) {
        ...
        let status = false;
        const cols = import_xe_utils15.default.isArray(fieldOrColumn) ? fieldOrColumn : [fieldOrColumn];
        let cWidth = import_xe_utils15.default.toInteger(width);
        if (isScale(width)) {
          const bodyScrollElem = getRefElem(elemStore["main-body-scroll"]);
      ...
      setRowHeightConf(heightConf) {
        ...
        let status = false;
        if (heightConf) {
          import_xe_utils15.default.each(heightConf, (height, rowid) => {
            const rowRest = fullAllDataRowIdData[rowid];
            if (rowRest) {
              const rHeight = import_xe_utils15.default.toInteger(height);
              if (rHeight) {
      ...
      setRowHeight(rowOrId, height) {
        const { fullAllDataRowIdData } = internalData;
        let status = false;
        const rows = import_xe_utils15.default.isArray(rowOrId) ? rowOrId : [rowOrId];
        let rHeight = import_xe_utils15.default.toInteger(height);
        if (isScale(height)) {
          const tableBody = refTableBody.value;
        ...
        if (rHeight) {
          const { handleGetRowId } = createHandleGetRowId($xeTable);
          rows.forEach((row) => {
            const rowid = import_xe_utils15.default.isString(row) || import_xe_utils15.default.isNumber(row) ? row : handleGetRowId(row);
            const rowRest = fullAllDataRowIdData[rowid];
            if (rowRest) {
              rowRest.resizeHeight = rHeight;
              if (!status) {
      ...
      getRowHeight(rowOrId) {
        ...
        const cellOpts = computeCellOpts.value;
        const defaultRowHeight = computeDefaultRowHeight.value;
        const rowid = import_xe_utils15.default.isString(rowOrId) || import_xe_utils15.default.isNumber(rowOrId) ? rowOrId : getRowid($xeTable, rowOrId);
        const rowRest = fullAllDataRowIdData[rowid];
        if (rowRest) {
      ...
      getCheckboxIndeterminateRecords(isFull) {
        ...
        if (treeConfig) {
          const fullRest = [];
          const defRest = [];
          import_xe_utils15.default.each(treeIndeterminateRowMaps, (item, rowid) => {
            if (item) {
              fullRest.push(item);
              if (fullDataRowIdData[rowid]) {
                defRest.push(item);
      ...
      setCheckboxRowKey(keys, checked) {
        const { fullAllDataRowIdData } = internalData;
        if (!import_xe_utils15.default.isArray(keys)) {
          keys = [keys];
        }
        const rows = [];
        keys.forEach((rowid) => {
      ...
      isCheckedByCheckboxRow(row) {
        ...
        const { checkField } = checkboxOpts;
        if (checkField) {
          return import_xe_utils15.default.get(row, checkField);
        }
      ...
      isCheckedByCheckboxRowKey(rowid) {
        ...
        if (checkField) {
          const rowRest = fullAllDataRowIdData[rowid];
          if (rowRest) {
            return import_xe_utils15.default.get(rowRest.row, checkField);
          }
          return false;
        }
      ...
      toggleCheckboxRow(row) {
        ...
        const checkboxOpts = computeCheckboxOpts.value;
        const { checkField } = checkboxOpts;
        const checked = checkField ? !import_xe_utils15.default.get(row, checkField) : !selectCheckboxMaps[getRowid($xeTable, row)];
      ...
      getRadioReserveRecord(isFull) {
        ...
        if (radioOpts.reserve && radioReserveRow) {
          ...
          if (isFull) {
            ...
            const rowkey = getRowkey($xeTable);
            if (treeConfig) {
              const matchObj = import_xe_utils15.default.findTree(afterFullData, (row) => rowid === import_xe_utils15.default.get(row, rowkey), { children: childrenField });
              if (matchObj) {
                return radioReserveRow;
              }
            } else {
              if (!afterFullData.some((row) => rowid === import_xe_utils15.default.get(row, rowkey))) {
                return radioReserveRow;
              }
            }
          }
      ...
      getCheckboxReserveRecords(isFull) {
        ...
        if (checkboxOpts.reserve) {
          ...
          if (treeConfig) {
            import_xe_utils15.default.eachTree(afterFullData, (row) => {
          ...
          import_xe_utils15.default.each(checkboxReserveRowMap, (oldRow, oldRowid) => {
            if (oldRow) {
              if (isFull) {
        ...
        if (checkField) {
          const handleClearChecked = (item) => {
            if (treeConfig && indeterminateField) {
              import_xe_utils15.default.set(item, indeterminateField, false);
            }
            import_xe_utils15.default.set(item, checkField, false);
          };
          if (treeConfig) {
            import_xe_utils15.default.eachTree(tableFullData, handleClearChecked, { children: childrenField });
          } else {
      ...
      setCurrentRow(row) {
        ...
        if (rowOpts.isCurrent || props.highlightCurrentRow) {
          if (el) {
            import_xe_utils15.default.arrayEach(el.querySelectorAll(`[rowid="${getRowid($xeTable, row)}"]`), (elem) => addClass(elem, "row--current"));
          }
        }
        return nextTick();
      },
      ...
      clearCurrentRow() {
        ...
        if (el) {
          import_xe_utils15.default.arrayEach(el.querySelectorAll(".row--current"), (elem) => removeClass(elem, "row--current"));
        }
        return nextTick();
      },
      /**
      ...
      getPendingRecords() {
        ...
        const insertRecords = [];
        import_xe_utils15.default.each(pendingRowMaps, (row, rowid) => {
          if (fullAllDataRowIdData[rowid]) {
      ...
      sort(sortConfs, sortOrder) {
        ...
        if (sortConfs) {
          if (import_xe_utils15.default.isString(sortConfs)) {
            sortConfs = [
              { field: sortConfs, order: sortOrder }
            ];
          }
        }
        if (!import_xe_utils15.default.isArray(sortConfs)) {
          sortConfs = [sortConfs];
        }
        if (sortConfs.length) {
          if (!multiple) {
          ...
          (multiple ? sortConfs : [sortConfs[0]]).forEach((confs, index) => {
            ...
            let column = field;
            if (import_xe_utils15.default.isString(field)) {
      ...
      getSortColumns() {
        ...
        if (multiple && chronological && sortList.length > 1) {
          return import_xe_utils15.default.orderBy(sortList, "sortTime");
        }
        return sortList;
      },
      /**
      ...
      setAllRowExpand(expanded) {
        ...
        let expandedRows = [];
        if (props.treeConfig) {
          import_xe_utils15.default.eachTree(tableFullTreeData, (row) => {
      ...
      getRowExpandRecords() {
        const rest = [];
        import_xe_utils15.default.each(internalData.rowExpandedMaps, (item) => {
          if (item) {
            rest.push(item);
          }
        });
      ...
      setRowGroups(fieldOrColumns) {
        ...
        if (fieldOrColumns) {
          handleUpdateRowGroup((import_xe_utils15.default.isArray(fieldOrColumns) ? fieldOrColumns : [fieldOrColumns]).map((fieldOrColumn) => {
            return import_xe_utils15.default.isString(fieldOrColumn) ? fieldOrColumn : fieldOrColumn.field;
          }));
      ...
      setAllRowGroupExpand(expanded) {
        ...
        if (expanded && mapChildrenField) {
          import_xe_utils15.default.eachTree(tableFullGroupData, (row) => {
            if (row[mapChildrenField] && row[mapChildrenField].length) {
      ...
      getTreeExpandRecords() {
        const rest = [];
        import_xe_utils15.default.each(internalData.treeExpandedMaps, (item) => {
          if (item) {
            rest.push(item);
          }
        });
      ...
      clearTreeExpandLoaded(rows) {
        ...
        if (rows) {
          ...
          import_xe_utils15.default.each(fullAllDataRowIdData, (rowRest) => {
            rowRest.treeLoaded = false;
          });
        }
        internalData.treeExpandedMaps = {};
      ...
      setAllTreeExpand(expanded) {
        ...
        const childrenField = treeOpts.children || treeOpts.childrenField;
        const expandeds = [];
        import_xe_utils15.default.eachTree(tableFullData, (row) => {
      ...
      clearTreeExpand() {
        ...
        internalData.treeExpandedMaps = {};
        if (reserve) {
          import_xe_utils15.default.eachTree(tableFullTreeData, (row) => handleTreeExpandReserve(row, false), { children: childrenField });
        }
      ...
      scrollTo(scrollLeft, scrollTop) {
        ...
        const yHandleEl = refScrollYHandleElem.value;
        internalData.intoRunScroll = true;
        if (import_xe_utils15.default.isNumber(scrollLeft)) {
        ...
        if (import_xe_utils15.default.isNumber(scrollTop)) {
      ...
      if (internalData.isActivated) {
        $xeTable.preventEvent(evnt, "event.keydown", null, () => {
          ...
          if (operCtxMenu) {
            ...
            const { parent: parentRow } = import_xe_utils15.default.findTree(internalData.afterTreeFullData, (item) => item === currentRow, { children: childrenField });
            if (parentRow) {
              evnt.preventDefault();
              const params = {
                row: parentRow,
    ...
    const clearRowDropOrigin = () => {
      ...
      if (el) {
        ...
        import_xe_utils15.default.arrayEach(el.querySelectorAll(`.${clss}`), (elem) => {
    ...
    const updateRowDropOrigin = (row) => {
      ...
      if (el) {
        const clss = "row--drag-origin";
        const rowid = getRowid($xeTable, row);
        import_xe_utils15.default.arrayEach(el.querySelectorAll(`[rowid="${rowid}"]`), (elem) => {
          addClass(elem, clss);
        });
      }
    };
    const updateRowDropTipContent = (tdEl) => {
      ...
      if (rTooltipMethod) {
        ...
        tipContent = getI18n9("vxe.table.dragTip", [tdEl.textContent || ""]);
      }
    ...
    const updateColDropOrigin = (column) => {
      ...
      if (el) {
        const colQuerys = [];
        import_xe_utils15.default.eachTree([column], (item) => {
          colQuerys.push(`[colid="${item.id}"]`);
        });
        const clss = "col--drag-origin";
        import_xe_utils15.default.arrayEach(el.querySelectorAll(colQuerys.join(",")), (elem) => {
          addClass(elem, clss);
        });
      }
    };
    ...
    const handleTooltip = (evnt, tdEl, overflowElem, tipElem, params) => {
      ...
      const useCustom = contentMethod && !import_xe_utils15.default.eqNull(customContent);
      const content = useCustom ? customContent : import_xe_utils15.default.toString(column.type === "html" ? tipOverEl.innerText : tipOverEl.textContent).trim();
    ...
    const callSlot = (slotFunc, params) => {
      if (slotFunc) {
        ...
        if (import_xe_utils15.default.isFunction(slotFunc)) {
    ...
    tablePrivateMethods = {
      ...
      defineField(records) {
        ...
        return records.map((record) => {
          internalData.tableFullColumn.forEach((column) => {
            ...
            if (field && !import_xe_utils15.default.has(record, field) && !record[field]) {
              let cellValue = null;
              if (editRender) {
                const { defaultValue } = editRender;
                if (import_xe_utils15.default.isFunction(defaultValue)) {
                  cellValue = defaultValue({ column });
                } else if (!import_xe_utils15.default.isUndefined(defaultValue)) {
                  cellValue = defaultValue;
                }
              }
              import_xe_utils15.default.set(record, field, cellValue);
            }
          });
          const otherFields = [radioOpts.labelField, checkboxOpts.checkField, checkboxOpts.labelField, expandOpts.labelField];
          otherFields.forEach((key) => {
            if (key && eqEmptyValue(import_xe_utils15.default.get(record, key))) {
              import_xe_utils15.default.set(record, key, null);
            }
          });
          if (treeConfig && treeOpts.lazy && import_xe_utils15.default.isUndefined(record[childrenField])) {
            record[childrenField] = null;
          }
          if (eqEmptyValue(import_xe_utils15.default.get(record, rowkey))) {
            import_xe_utils15.default.set(record, rowkey, getRowUniqueId());
          }
          return record;
        });
      },
      ...
      cacheRowMap(isReset) {
        ...
        if (treeConfig) {
          ...
          const childrenField = treeOpts.children || treeOpts.childrenField;
          const hasChildField = treeOpts.hasChild || treeOpts.hasChildField;
          import_xe_utils15.default.eachTree(tableFullTreeData, (row, index, items, path, parentRow, nodes) => {
          ...
          const rowGroupOpts = computeRowGroupOpts.value;
          const { mapChildrenField } = rowGroupOpts;
          import_xe_utils15.default.eachTree(tableFullGroupData, (row, index, items, path, parentRow, nodes) => {
            const rowid = handleUpdateRowId(row);
            handleRowCache(row, index, items, parentRow ? -1 : index, parentRow, rowid, nodes.length - 1, toTreePathSeq(path));
          }, { children: mapChildrenField });
        } else {
      ...
      cacheSourceMap(fullData) {
        const { treeConfig } = props;
        const treeOpts = computeTreeOpts.value;
        const sourceData = import_xe_utils15.default.clone(fullData, true);
        const { handleUpdateRowId } = createHandleUpdateRowId($xeTable);
        ...
        if (treeConfig) {
          const childrenField = treeOpts.children || treeOpts.childrenField;
          import_xe_utils15.default.eachTree(sourceData, handleSourceRow, { children: treeOpts.transform ? treeOpts.mapChildrenField : childrenField });
        } else {
      ...
      handleColResizeMousedownEvent(evnt, fixedType, params) {
        ...
        if (column.children && column.children.length) {
          import_xe_utils15.default.eachTree(column.children, (childColumn) => {
        ...
        const updateEvent = (evnt2) => {
          ...
          if (resizableOpts.showDragTip && resizeTipElem) {
            resizeTipElem.textContent = getI18n9("vxe.table.resizeColTip", [resizeColumn.renderWidth + (isRightFixed ? dragPosLeft - dragLeft : dragLeft - dragPosLeft)]);
      ...
      handleRowResizeMousedownEvent(evnt, params) {
        ...
        if (cellEl) {
          ...
          cellMinHeight = Math.max(1, Math.ceil(import_xe_utils15.default.toNumber(cellStyle.paddingTop) + import_xe_utils15.default.toNumber(cellStyle.paddingBottom)));
        }
        ...
        const updateEvent = (evnt2) => {
          ...
          if (resizableOpts.showDragTip && resizeTipElem) {
            resizeTipElem.textContent = getI18n9("vxe.table.resizeRowTip", [resizeHeight]);
            const resizeTipWidth = resizeTipElem.clientWidth;
            const resizeTipHeight = resizeTipElem.clientHeight;
        ...
        if (isRowGroupStatus || treeConfig) {
          ...
          childRowList.forEach((vals) => {
            ...
            childList.forEach(checkMethod ? (item) => {
              ...
              const isSelect = checkField ? import_xe_utils15.default.get(item, checkField) : selectCheckboxMaps[childRowid];
            ...
            if (checkField) {
              import_xe_utils15.default.set(row, checkField, isSelected);
            }
            if (isSelected) {
              if (!checkField) {
      ...
      updateAllCheckboxStatus() {
        ...
        rootList.forEach(checkMethod ? (row) => {
          ...
          const selected = checkField ? import_xe_utils15.default.get(row, checkField) : selectCheckboxMaps[childRowid];
        ...
        if (!isSelected && !halfSelect && showReserveStatus) {
          halfSelect = !import_xe_utils15.default.isEmpty(checkboxReserveRowMap);
        }
      ...
      handleBatchSelectRows(rows, checked, isForce) {
        ...
        if (checkField) {
          if ((treeConfig || isRowGroupStatus) && !checkStrictly) {
            import_xe_utils15.default.eachTree(rows, (row) => {
              if (isForce || (!checkMethod || checkMethod({ $table: $xeTable, row }))) {
                import_xe_utils15.default.set(row, checkField, checked);
                if (indeterminateField) {
                  import_xe_utils15.default.set(row, indeterminateField, false);
      ...
      handleToggleCheckRowEvent(evnt, params) {
        ...
        let checked = false;
        if (checkField) {
          checked = !import_xe_utils15.default.get(row, checkField);
        } else {
      ...
      handleCellRuleUpdateStatus(type, cellParams, cellValue) {
        ...
        if ($xeTable.hasCellRules) {
          if ($xeTable.hasCellRules(type, row, column)) {
            ...
            if (cell) {
              const customVal = !import_xe_utils15.default.isUndefined(cellValue);
              ...
              if (treeConfig) {
                if (transform) {
                  ...
                  if (oldRest && newRest) {
                    ...
                    const oldAllMaps = {};
                    import_xe_utils15.default.eachTree([dragRow], (item) => {
                        ...
                        if (oldAllMaps[newRowid]) {
                          ...
                          if (!(isCrossDrag && isSelfToChildDrag)) {
                            if (VxeUI.modal) {
                              VxeUI.modal.message({
                                status: "error",
                                content: getI18n9("vxe.error.treeDragChild")
                              });
                            }
                            return errRest;
                          }
                    ...
                    const fullList = import_xe_utils15.default.toTreeArray(internalData.afterTreeFullData, {
                      key: rowField,
                      parentKey: parentField,
                      children: mapChildrenField
                    });
                    ...
                    if (isSelfToChildStatus && (isCrossDrag && isSelfToChildDrag)) {
                      import_xe_utils15.default.each(dragRow[childrenField], (childRow) => {
                        childRow[parentField] = dragRow[parentField];
                      });
                    }
                    dragRow[parentField] = isDragToChildFlag ? prevDragRow[rowField] : prevDragRow[parentField];
                    internalData.tableFullTreeData = import_xe_utils15.default.toArrayTree(fullList, {
                      key: rowField,
                      parentKey: parentField,
                      children: childrenField,
                      mapChildren: mapChildrenField
        ...
        if (prevDragCol && dragCol) {
          if (prevDragCol !== dragCol) {
            ...
            return Promise.resolve(dragEndMethod ? dragEndMethod(dragParams) : true).then((status) => {
              ...
              let nafIndex = -1;
              const oldAllMaps = {};
              import_xe_utils15.default.eachTree([dragColumn], (column) => {
                oldAllMaps[column.id] = column;
              });
              let isSelfToChildStatus = false;
              if (dragColumn.parentId && newColumn.parentId) {
              ...
              const oldewMatchRest = import_xe_utils15.default.findTree(collectColumn, (item) => item.id === dragColumn.id);
              if (isSelfToChildStatus && (isCrossDrag && isSelfToChildDrag)) {
                if (oldewMatchRest) {
                  const { items: oCols, index: oIndex } = oldewMatchRest;
                  const childList = dragColumn.children || [];
              ...
              const newMatchRest = import_xe_utils15.default.findTree(collectColumn, (item) => item.id === newColumn.id);
              if (newMatchRest) {
                const { items: nCols, index: nIndex, parent: nParent } = newMatchRest;
      ...
      triggerBodyWheelEvent(evnt) {
        ...
        if (isRollX) {
          ...
          if (browseObj2.firefox || browseObj2.safari) {
      ...
      scrollToTreeRow(row) {
        ...
        if (treeConfig || isRowGroupStatus) {
          ...
          const treeOpts = computeTreeOpts.value;
          const childrenField = treeOpts.children || treeOpts.childrenField;
          const matchObj = import_xe_utils15.default.findTree(tableFullData, (item) => $xeTable.eqRow(item, row), { children: isRowGroupStatus ? rowGroupOpts.mapChildrenField : childrenField });
          if (matchObj) {
      ...
      setHoverRow(row) {
        ...
        if (el) {
          import_xe_utils15.default.arrayEach(el.querySelectorAll(`.vxe-body--row[rowid="${rowid}"]`), (elem) => addClass(elem, "row--hover"));
        }
      ...
      clearHoverRow() {
        const el = refElem.value;
        if (el) {
          import_xe_utils15.default.arrayEach(el.querySelectorAll(".vxe-body--row.row--hover"), (elem) => removeClass(elem, "row--hover"));
        }
        internalData.hoverRow = null;
      },
      /**
      ...
      findRowIndexOf(list, row) {
        return row ? import_xe_utils15.default.findIndexOf(list, (item) => $xeTable.eqRow(item, row)) : -1;
      },
      eqRow(row1, row2) {
        if (row1 && row2) {
          if (row1 === row2) {
    ...
    const renderEmptyBody = () => {
      ...
      if (slots.empty) {
        ...
        const compConf = emptyOpts.name ? renderer7.get(emptyOpts.name) : null;
        const rtEmptyView = compConf ? compConf.renderTableEmpty || compConf.renderTableEmptyView || compConf.renderEmpty : null;
        if (rtEmptyView) {
    ...
    const renderDragTip = () => {
          ...
          dragRow && rowDragOpts.showDragTip || dragCol && columnDragOpts.showDragTip ? h("div", {
            ...
            h("div", {
              ...
              h("div", {
                ...
                h("span", {
                  class: ["vxe-table--drag-sort-tip-normal-status", dragRow ? getIcon8().TABLE_DRAG_STATUS_ROW : getIcon8().TABLE_DRAG_STATUS_COLUMN]
                }),
                h("span", {
                  class: ["vxe-table--drag-sort-tip-sub-status", getIcon8().TABLE_DRAG_STATUS_SUB_ROW]
                }),
                h("span", {
                  class: ["vxe-table--drag-sort-tip-disabled-status", getIcon8().TABLE_DRAG_DISABLED]
                })
              ]),
              h("div", {
      ...
      return renderEmptyElement6($xeTable);
    };
    const renderRowExpandedVNs = () => {
      ...
      if (expandColumn) {
        ...
        tableRowExpandedList.forEach((row) => {
          ...
          if (isRowGroupStatus || treeConfig) {
            cellStyle.paddingLeft = `${rowLevel * (import_xe_utils15.default.isNumber(indent) ? indent : treeOpts.indent) + 30}px`;
          }
          let columnIndex = -1;
          let $columnIndex = -1;
          let _columnIndex = -1;
    ...
    const renderViewport = () => {
      ...
      return h("div", {
        ...
        h("div", {
          ...
          leftList && leftList.length && overflowX ? renderFixed("left") : renderEmptyElement6($xeTable),
          rightList && rightList.length && overflowX ? renderFixed("right") : renderEmptyElement6($xeTable)
        ]),
    ...
    const renderVN = () => {
      ...
      return h("div", {
        ...
        }, callSlot(loadingSlot, { $table: $xeTable, $grid: $xeGrid, loading: currLoading })) : renderEmptyElement6($xeTable),
        /**
         * 自定义列
         */
    ...
    watch(staticColumnFlag, () => {
      handleColumn(import_xe_utils15.default.clone(reactData.staticColumns));
    });
    ...
    hooks2.forEach((options) => {
      ...
      if (setupTable) {
        ...
        if (hookRest && import_xe_utils15.default.isObject(hookRest)) {
    ...
    onMounted(() => {
      ...
      nextTick(() => {
        ...
        if (importConfig && importOpts.types && !importOpts.importMethod && !import_xe_utils15.default.includeArrays(import_xe_utils15.default.keys(importOpts._typeMaps), importOpts.types)) {
          warnLog("vxe.error.errProp", [`export-config.types=${importOpts.types.join(",")}`, importOpts.types.filter((type) => import_xe_utils15.default.includes(import_xe_utils15.default.keys(importOpts._typeMaps), type)).join(",") || import_xe_utils15.default.keys(importOpts._typeMaps).join(",")]);
        }
        if (exportConfig && exportOpts.types && !exportOpts.exportMethod && !import_xe_utils15.default.includeArrays(import_xe_utils15.default.keys(exportOpts._typeMaps), exportOpts.types)) {
          warnLog("vxe.error.errProp", [`export-config.types=${exportOpts.types.join(",")}`, exportOpts.types.filter((type) => import_xe_utils15.default.includes(import_xe_utils15.default.keys(exportOpts._typeMaps), type)).join(",") || import_xe_utils15.default.keys(exportOpts._typeMaps).join(",")]);
        }
        if (!props.id) {
        ...
        if ((rowOpts2.isCurrent || highlightCurrentRow) && props.keyboardConfig && keyboardOpts.isArrow && !import_xe_utils15.default.isBoolean(currentRowOpts.isFollowSelected)) {
          warnLog("vxe.error.notConflictProp", ["row-config.isCurrent", "current-row-config.isFollowSelected"]);
        }
        if ((columnOpts.isCurrent || highlightCurrentColumn) && props.keyboardConfig && keyboardOpts.isArrow && !import_xe_utils15.default.isBoolean(currentColumnOpts.isFollowSelected)) {
...
var { getConfig: getConfig4, getIcon: getIcon9, getI18n: getI18n10, renderer: renderer8, commands: commands2, createEvent: createEvent2, useFns: useFns2 } = VxeUI;
var toolbar_default = defineComponent({
  ...
  props: {
    ...
    buttons: {
      type: Array,
      default: () => getConfig4().toolbar.buttons
    },
    tools: {
      type: Array,
      default: () => getConfig4().toolbar.tools
    },
    perfect: {
      type: Boolean,
      default: () => getConfig4().toolbar.perfect
    },
    size: {
      type: String,
      default: () => getConfig4().toolbar.size || getConfig4().size
    },
    className: [String, Function]
  },
  emits: [
  ...
  setup(props, context) {
    ...
    const computeRefreshOpts = computed(() => {
      return Object.assign({}, import_xe_utils16.default.clone(getConfig4().toolbar.refresh, true), props.refresh);
    });
    const computeImportOpts = computed(() => {
      return Object.assign({}, import_xe_utils16.default.clone(getConfig4().toolbar.import, true), props.import);
    });
    const computeExportOpts = computed(() => {
      return Object.assign({}, import_xe_utils16.default.clone(getConfig4().toolbar.export, true), props.export);
    });
    const computePrintOpts = computed(() => {
      return Object.assign({}, import_xe_utils16.default.clone(getConfig4().toolbar.print, true), props.print);
    });
    const computeZoomOpts = computed(() => {
      return Object.assign({}, import_xe_utils16.default.clone(getConfig4().toolbar.zoom, true), props.zoom);
    });
    const computeCustomOpts = computed(() => {
      return Object.assign({}, import_xe_utils16.default.clone(getConfig4().toolbar.custom, true), props.custom);
    });
      ...
      if (buttons) {
        buttons.forEach((item, index) => {
          ...
          if (item.visible !== false) {
            const compConf = buttonRender ? renderer8.get(buttonRender.name) : null;
            if (buttonRender && compConf && compConf.renderToolbarButton) {
              const toolbarButtonClassName = compConf.toolbarButtonClassName;
              const params = { $grid: $xeGrid, $table, button: item };
              btnVNs.push(h("span", {
                key: `br${item.code || index}`,
                class: ["vxe-button--item", toolbarButtonClassName ? import_xe_utils16.default.isFunction(toolbarButtonClassName) ? toolbarButtonClassName(params) : toolbarButtonClassName : ""]
      ...
      if (tools) {
        tools.forEach((item, tIndex) => {
          ...
          if (item.visible !== false) {
            ...
            const compConf = toolRender ? renderer8.get(rdName) : null;
            if (toolRender && compConf && compConf.renderToolbarTool) {
              const toolbarToolClassName = compConf.toolbarToolClassName;
              const params = { $grid: $xeGrid, $table, tool: item };
              btnVNs.push(h("span", {
                key: rdName,
                class: ["vxe-tool--item", toolbarToolClassName ? import_xe_utils16.default.isFunction(toolbarToolClassName) ? toolbarToolClassName(params) : toolbarToolClassName : ""]
    ...
    const renderToolImport = () => {
      ...
      return VxeUIButtonComponent ? h(VxeUIButtonComponent, {
        key: "import",
        circle: true,
        icon: importOpts.icon || getIcon9().TOOLBAR_TOOLS_IMPORT,
        title: getI18n10("vxe.toolbar.import"),
        onClick: importEvent
      }) : createCommentVNode();
    };
    const renderToolExport = () => {
      ...
      return VxeUIButtonComponent ? h(VxeUIButtonComponent, {
        key: "export",
        circle: true,
        icon: exportOpts.icon || getIcon9().TOOLBAR_TOOLS_EXPORT,
        title: getI18n10("vxe.toolbar.export"),
        onClick: exportEvent
      }) : createCommentVNode();
    };
    const renderToolPrint = () => {
      ...
      return VxeUIButtonComponent ? h(VxeUIButtonComponent, {
        key: "print",
        circle: true,
        icon: printOpts.icon || getIcon9().TOOLBAR_TOOLS_PRINT,
        title: getI18n10("vxe.toolbar.print"),
        onClick: printEvent
      }) : createCommentVNode();
    };
    const renderToolRefresh = () => {
      ...
      return VxeUIButtonComponent ? h(VxeUIButtonComponent, {
        key: "refresh",
        circle: true,
        icon: reactData.isRefresh ? refreshOpts.iconLoading || getIcon9().TOOLBAR_TOOLS_REFRESH_LOADING : refreshOpts.icon || getIcon9().TOOLBAR_TOOLS_REFRESH,
        title: getI18n10("vxe.toolbar.refresh"),
    ...
    const renderToolZoom = () => {
      ...
      return $xeGrid && VxeUIButtonComponent ? h(VxeUIButtonComponent, {
        key: "zoom",
        circle: true,
        icon: $xeGrid.isMaximized() ? zoomOpts.iconOut || getIcon9().TOOLBAR_TOOLS_MINIMIZE : zoomOpts.iconIn || getIcon9().TOOLBAR_TOOLS_FULLSCREEN,
        title: getI18n10(`vxe.toolbar.zoom${$xeGrid.isMaximized() ? "Out" : "In"}`),
        onClick: zoomEvent
      }) : createCommentVNode();
    };
    const renderToolCustom = () => {
      ...
      return VxeUIButtonComponent ? h(VxeUIButtonComponent, Object.assign({ key: "custom", circle: true, icon: customOpts.icon || getIcon9().TOOLBAR_TOOLS_CUSTOM, title: getI18n10("vxe.toolbar.custom"), className: "vxe-toolbar-custom-target" }, customBtnOns)) : createCommentVNode();
    };
    const renderVN = () => {
      ...
      return h("div", {
        ref: refElem,
        class: ["vxe-toolbar", className ? import_xe_utils16.default.isFunction(className) ? className({ $toolbar: $xeToolbar }) : className : "", {
          [`size--${vSize}`]: vSize,
          "is--perfect": perfect,
          "is--loading": loading
        }]
...
// node_modules/vxe-table/es/grid/src/grid.js
var { getConfig: getConfig5, getI18n: getI18n11, commands: commands3, hooks: hooks3, useFns: useFns3, createEvent: createEvent3, globalEvents: globalEvents3, GLOBAL_EVENT_KEYS: GLOBAL_EVENT_KEYS2, renderEmptyElement: renderEmptyElement7 } = VxeUI;
...
var grid_default = defineComponent({
  ...
  props: Object.assign(Object.assign({}, props_default), { layouts: Array, columns: Array, pagerConfig: Object, proxyConfig: Object, toolbarConfig: Object, formConfig: Object, zoomConfig: Object, size: {
    type: String,
    default: () => getConfig5().grid.size || getConfig5().size
  } }),
  ...
  setup(props, context) {
    ...
    const reactData = reactive({
      ...
      tablePage: {
        total: 0,
        pageSize: ((_a = getConfig5().pager) === null || _a === void 0 ? void 0 : _a.pageSize) || 10,
        currentPage: 1
      }
    });
    const refElem = ref();
    ...
    const computeProxyOpts = computed(() => {
      return import_xe_utils17.default.merge({}, import_xe_utils17.default.clone(getConfig5().grid.proxyConfig, true), props.proxyConfig);
    });
    const computeIsRespMsg = computed(() => {
      const proxyOpts = computeProxyOpts.value;
      return import_xe_utils17.default.isBoolean(proxyOpts.message) ? proxyOpts.message : proxyOpts.showResponseMsg;
    });
    ...
    const computePagerOpts = computed(() => {
      return Object.assign({}, getConfig5().grid.pagerConfig, props.pagerConfig);
    });
    const computeFormOpts = computed(() => {
      return Object.assign({}, getConfig5().grid.formConfig, props.formConfig);
    });
    const computeToolbarOpts = computed(() => {
      return Object.assign({}, getConfig5().grid.toolbarConfig, props.toolbarConfig);
    });
    const computeZoomOpts = computed(() => {
      return Object.assign({}, getConfig5().grid.zoomConfig, props.zoomConfig);
    });
    ...
    const computeCurrLayoutConf = computed(() => {
      ...
      if (layouts && layouts.length) {
        ...
        confs = getConfig5().grid.layouts || defaultLayouts;
      }
      let headKeys = [];
      let bodyKeys = [];
      let footKeys = [];
      if (confs.length) {
        if (import_xe_utils17.default.isArray(confs[0])) {
          headKeys = confs[0];
          bodyKeys = confs[1] || [];
          footKeys = confs[2] || [];
        } else {
    ...
    const triggerPendingEvent = (code) => {
      ...
      if (selectRecords.length) {
        ...
        if (isActiveMsg) {
          if (VxeUI.modal) {
            VxeUI.modal.message({ id: code, content: getI18n11("vxe.grid.selectOneRecord"), status: "warning" });
          }
        }
      }
    };
    const getRespMsg = (rest, defaultMsg) => {
      ...
      let msg;
      if (rest && messageProp) {
        msg = import_xe_utils17.default.isFunction(messageProp) ? messageProp({ data: rest, $grid: $xeGrid }) : import_xe_utils17.default.get(rest, messageProp);
      }
      return msg || getI18n11(defaultMsg);
    };
    const handleDeleteRow = (code, alertKey, callback) => {
      ...
      if (isActiveMsg) {
        if (selectRecords.length) {
          if (VxeUI.modal) {
            return VxeUI.modal.confirm({ id: `cfm_${code}`, content: getI18n11(alertKey), escClosable: true }).then((type) => {
              if (type === "confirm") {
                return callback();
              }
            });
          ...
          if (VxeUI.modal) {
            VxeUI.modal.message({ id: `msg_${code}`, content: getI18n11("vxe.grid.selectOneRecord"), status: "warning" });
          }
        }
      } else {
        if (selectRecords.length) {
    ...
    const getFuncSlot = (optSlots, slotKey) => {
      ...
      if (funcSlot) {
        if (import_xe_utils17.default.isString(funcSlot)) {
          if (slots[funcSlot]) {
    ...
    const getConfigSlot = (slotConfigs) => {
      const slotConf = {};
      import_xe_utils17.default.objectMap(slotConfigs, (slotFunc, slotKey) => {
        if (slotFunc) {
    ...
    const renderForm = () => {
      ...
      if (formConfig && isEnableConf(formOpts) || slots.form) {
        ...
        if (slots.form) {
          ...
          if (formOpts.items) {
            ...
            formOpts.items.forEach((item) => {
              import_xe_utils17.default.each(item.slots, (func) => {
      ...
      return renderEmptyElement7($xeGrid);
    };
    const renderToolbar = () => {
    ...
    const renderPager = () => {
      ...
      if (pagerConfig && isEnableConf(pagerOpts) || slots.pager) {
        return h("div", {
          ...
          VxeUIPagerComponent ? h(VxeUIPagerComponent, Object.assign(Object.assign(Object.assign({ ref: refPager }, pagerOpts), proxyConfig && isEnableConf(proxyOpts) ? reactData.tablePage : {}), { onPageChange: pageChangeEvent }), getConfigSlot(pagerOpts.slots)) : renderEmptyElement7($xeGrid)
        ]);
      }
      return renderEmptyElement7($xeGrid);
    };
    ...
    const renderLayout = () => {
      ...
      return [
        ...
        h("div", {
          ...
          }, asideLeftSlot({})) : renderEmptyElement7($xeGrid),
          h("div", {
          ...
          }, asideRightSlot({})) : renderEmptyElement7($xeGrid)
        ]),
        h("div", {
    ...
    emits_default.forEach((name) => {
      const type = import_xe_utils17.default.camelCase(`on-${name}`);
          ...
          formOpts.items.forEach((item) => {
            ...
            if (field) {
              ...
              if (itemRender) {
                ...
                if (import_xe_utils17.default.isFunction(defaultValue)) {
                  itemValue = defaultValue({ item });
                } else if (!import_xe_utils17.default.isUndefined(defaultValue)) {
    ...
    const gridMethods = {
      ...
      commitProxy(proxyTarget, ...args) {
        ...
        let button = null;
        let code = null;
        if (import_xe_utils17.default.isString(proxyTarget)) {
          const { buttons } = toolbarOpts;
          const matchObj = toolbarConfig && isEnableConf(toolbarOpts) && buttons ? import_xe_utils17.default.findTree(buttons, (item) => item.code === proxyTarget, { children: "dropdowns" }) : null;
          ...
          case "query": {
            ...
            if (ajaxMethods) {
              ...
              if (isInited) {
                ...
                if (defaultSort) {
                  if (!import_xe_utils17.default.isArray(defaultSort)) {
                    defaultSort = [defaultSort];
                  }
              ...
              return Promise.resolve((beforeQuery || ajaxMethods)(commitParams, ...args)).then((rest) => {
                ...
                if (rest) {
                  if (pagerConfig && isEnableConf(pagerOpts)) {
                    ...
                    const total = (import_xe_utils17.default.isFunction(totalProp) ? totalProp({ data: rest, $grid: $xeGrid }) : import_xe_utils17.default.get(rest, totalProp || "page.total")) || 0;
                    tablePage.total = import_xe_utils17.default.toNumber(total);
                    const resultProp = resConfigs.result;
                    tableData = (import_xe_utils17.default.isFunction(resultProp) ? resultProp({ data: rest, $grid: $xeGrid }) : import_xe_utils17.default.get(rest, resultProp || "result")) || [];
                    ...
                    tableData = (listProp ? import_xe_utils17.default.isFunction(listProp) ? listProp({ data: rest, $grid: $xeGrid }) : import_xe_utils17.default.get(rest, listProp) : rest) || [];
                  }
                }
                if ($xeTable) {
            ...
            if (ajaxMethods) {
              ...
              return restPromise.then((errMap) => {
                ...
                if (body.insertRecords.length || removeRecords.length || updateRecords.length || body.pendingRecords.length) {
                  ...
                  if (isActiveMsg) {
                    if (VxeUI.modal) {
                      VxeUI.modal.message({ id: code, content: getI18n11("vxe.grid.dataUnchanged"), status: "info" });
                    }
                  }
                }
              });
      ...
      getFormItems(itemIndex) {
        ...
        const itemList = [];
        import_xe_utils17.default.eachTree(formConfig && isEnableConf(formOpts) && items ? items : [], (item) => {
          itemList.push(item);
        }, { children: "children" });
        return import_xe_utils17.default.isUndefined(itemIndex) ? itemList : itemList[itemIndex];
      },
      getProxyInfo() {
        const $xeTable = refTable.value;
    ...
    if (true) {
      gridMethods.loadColumn = (columns) => {
        const $xeTable = refTable.value;
        import_xe_utils17.default.eachTree(columns, (column) => {
          if (column.slots) {
            import_xe_utils17.default.each(column.slots, (func) => {
              if (!import_xe_utils17.default.isFunction(func)) {
                if (!slots[func]) {
    ...
    const gridPrivateMethods = {
      ...
      getParentHeight() {
        ...
        if (el) {
          const parentEl = el.parentElement;
          return (reactData.isZMax ? getDomNode().visibleHeight : parentEl ? import_xe_utils17.default.toNumber(getComputedStyle(parentEl).height) : 0) - gridPrivateMethods.getExcludeHeight();
        }
        return 0;
      },
    ...
    hooks3.forEach((options) => {
      ...
      if (setupGrid) {
        ...
        if (hookRest && import_xe_utils17.default.isObject(hookRest)) {
...
function useCellView(props) {
  ...
  const cellModel = computed({
    get() {
      ...
      return import_xe_utils18.default.get(row, column.field);
    },
    set(value) {
      const { renderParams } = props;
      const { row, column } = renderParams;
      return import_xe_utils18.default.set(row, column.field, value);
    }
  });
  return {
    currColumn,
        ...
        if (column) {
          ...
          if (filters) {
            ...
            filters.forEach((item) => {
              ...
              item.checked = false;
              if (!frMethod) {
                item.data = import_xe_utils19.default.clone(item.resetValue, true);
              }
            });
            if (frMethod) {
...
var { menus: menus2, hooks: hooks5, globalEvents: globalEvents4, GLOBAL_EVENT_KEYS: GLOBAL_EVENT_KEYS3 } = VxeUI;
  ...
  setupTable($xeTable) {
    ...
    menuPrivateMethods = {
      ...
      moveCtxMenu(evnt, ctxMenuStore, property, hasOper, operRest, menuList) {
        let selectItem;
        const selectIndex = import_xe_utils20.default.findIndexOf(menuList, (item) => ctxMenuStore[property] === item);
        if (hasOper) {
...
var { getConfig: getConfig6, renderer: renderer10, hooks: hooks6, getI18n: getI18n12 } = VxeUI;
...
hooks6.add("tableEditModule", {
  setupTable($xeTable) {
    ...
    const browseObj2 = import_xe_utils21.default.browse();
    let editMethods = {};
    ...
    const insertTreeRow = (newRecords, isAppend) => {
      ...
      newRecords.forEach((item) => {
        ...
        const matchObj = parentRowId ? import_xe_utils21.default.findTree(tableFullTreeData, (item2) => parentRowId === item2[rowField], { children: mapChildrenField }) : null;
        if (matchObj) {
          ...
          if (!import_xe_utils21.default.isArray(parentChilds)) {
            parentChilds = parentRow[childrenField] = [];
          }
          if (!import_xe_utils21.default.isArray(mapChilds)) {
    ...
    const handleInsertRowAt = (records, targetRow, isInsertNextRow) => {
      ...
      const childrenField = treeOpts.children || treeOpts.childrenField;
      if (!import_xe_utils21.default.isArray(records)) {
        records = [records];
      }
      ...
      if (import_xe_utils21.default.eqNull(targetRow)) {
        if (treeConfig && transform) {
        ...
        if (targetRow === -1) {
          ...
          if (treeConfig && transform) {
            const matchMapObj = import_xe_utils21.default.findTree(tableFullTreeData, (item) => targetRow[rowField] === item[rowField], { children: mapChildrenField });
            if (matchMapObj) {
              ...
              if (parentRow) {
                const matchObj = import_xe_utils21.default.findTree(tableFullTreeData, (item) => targetRow[rowField] === item[rowField], { children: childrenField });
                if (matchObj) {
            ...
            if (treeConfig) {
              throw new Error(getI18n12("vxe.error.noTree", ["insert"]));
            }
            let afIndex = -1;
            if (import_xe_utils21.default.isNumber(targetRow)) {
            ...
            if (afIndex === -1) {
              throw new Error(getI18n12("vxe.error.unableInsert"));
            }
    ...
    const handleClearEdit = (evnt, targetRow) => {
      ...
      if (validOpts.autoClear) {
        if (validOpts.msgMode !== "full" || getConfig6().cellVaildMode === "obsolete") {
    ...
    const handleEditCell = (row, fieldOrColumn, isPos) => {
      const { editConfig } = props;
      const column = import_xe_utils21.default.isString(fieldOrColumn) ? $xeTable.getColumnByField(fieldOrColumn) : fieldOrColumn;
    ...
    editMethods = {
      ...
      remove(rows) {
        ...
        if (!rows) {
          rows = tableFullData;
        } else if (!import_xe_utils21.default.isArray(rows)) {
          rows = [rows];
        }
        rows.forEach((row) => {
          if (!$xeTable.isInsertByRow(row)) {
        ...
        if (tableFullData === rows) {
          ...
          if (treeConfig && transform) {
            rows.forEach((row) => {
              const rowid = getRowid($xeTable, row);
              const matchMapObj = import_xe_utils21.default.findTree(tableFullTreeData, (item) => rowid === getRowid($xeTable, item), { children: mapChildrenField });
              if (matchMapObj) {
                const rItems = matchMapObj.items.splice(matchMapObj.index, 1);
                delList.push(rItems[0]);
              }
              const matchObj = import_xe_utils21.default.findTree(tableFullTreeData, (item) => rowid === getRowid($xeTable, item), { children: childrenField });
              if (matchObj) {
                matchObj.items.splice(matchObj.index, 1);
              }
      ...
      getInsertRecords() {
        ...
        const insertRecords = [];
        import_xe_utils21.default.each(insertRowMaps, (row, rowid) => {
          if (fullAllDataRowIdData[rowid]) {
            insertRecords.push(row);
          }
        });
      ...
      getRemoveRecords() {
        ...
        const removeRecords = [];
        import_xe_utils21.default.each(removeRowMaps, (row) => {
      ...
      getUpdateRecords() {
        ...
        if (keepSource) {
          syncActivedCell();
          if (treeConfig) {
            return import_xe_utils21.default.filterTree(tableFullData, (row) => $xeTable.isUpdateByRow(row), treeOpts);
          }
      ...
      setEditRow(row, fieldOrColumn) {
        const { visibleColumn } = internalData;
        let column = import_xe_utils21.default.find(visibleColumn, (column2) => isEnableConf(column2.editRender));
        let isPos = false;
        if (fieldOrColumn) {
          isPos = true;
          if (fieldOrColumn !== true) {
            column = import_xe_utils21.default.isString(fieldOrColumn) ? $xeTable.getColumnByField(fieldOrColumn) : fieldOrColumn;
          }
        }
      ...
      handleFocus(params) {
        ...
        if (isEnableConf(editRender)) {
          ...
          if (editOpts.autoFocus) {
            ...
            if (import_xe_utils21.default.isFunction(autoFocus)) {
...
// node_modules/vxe-table/es/table/module/export/hook.js
var { getI18n: getI18n13, hooks: hooks7, renderer: renderer11 } = VxeUI;
var htmlCellElem;
var csvBOM = "\uFEFF";
var enterSymbol = "\r\n";
...
function getTxtCellKey(now) {
  return `#${now}@${import_xe_utils22.default.uniqueId()}`;
}
function replaceTxtCell(cell, vMaps) {
  return cell.replace(/#\d+@\d+/g, (key) => import_xe_utils22.default.hasOwnProp(vMaps, key) ? vMaps[key] : key);
}
  ...
  if (bodyNodes.length) {
    ...
    if (tableNodes.length) {
      ...
      if (theadNodes.length) {
        import_xe_utils22.default.arrayEach(getElementsByTagName(theadNodes[0], "tr"), (rowNode) => {
          import_xe_utils22.default.arrayEach(getElementsByTagName(rowNode, "th"), (cellNode) => {
            fields.push(toExportField(tableConf, cellNode.textContent || ""));
          });
        });
        const tbodyNodes = getElementsByTagName(tableNodes[0], "tbody");
        if (tbodyNodes.length) {
          import_xe_utils22.default.arrayEach(getElementsByTagName(tbodyNodes[0], "tr"), (rowNode) => {
            const item = {};
            import_xe_utils22.default.arrayEach(getElementsByTagName(rowNode, "td"), (cellNode, colIndex) => {
              if (fields[colIndex]) {
...
function parseXML(tableConf, content) {
  ...
  if (sheetNodes.length) {
    ...
    if (tableNodes.length) {
      ...
      if (rowNodes.length) {
        import_xe_utils22.default.arrayEach(getElementsByTagName(rowNodes[0], "Cell"), (cellNode) => {
          fields.push(toExportField(tableConf, cellNode.textContent || ""));
        });
        import_xe_utils22.default.arrayEach(rowNodes, (rowNode, index) => {
          if (index) {
            const item = {};
            const cellNodes = getElementsByTagName(rowNode, "Cell");
            import_xe_utils22.default.arrayEach(cellNodes, (cellNode, colIndex) => {
              if (fields[colIndex]) {
                item[fields[colIndex]] = cellNode.textContent;
              }
            });
...
function clearColumnConvert(columns) {
  import_xe_utils22.default.eachTree(columns, (column) => {
...
hooks7.add("tableExportModule", {
  setupTable($xeTable) {
    ...
    const toBooleanValue = (cellValue) => {
      return import_xe_utils22.default.isBoolean(cellValue) ? cellValue ? "TRUE" : "FALSE" : cellValue;
    };
    ...
    const getBodyLabelData = (opts, columns, datas) => {
      ...
      if (treeConfig) {
        ...
        import_xe_utils22.default.eachTree(datas, (item, $rowIndex, items, path, parent, nodes) => {
              ...
              if (bodyExportMethod) {
                ...
                switch (column.type) {
                  ...
                  case "checkbox":
                    ...
                    item2._checkboxLabel = checkboxOpts.labelField ? import_xe_utils22.default.get(row, checkboxOpts.labelField) : "";
                    item2._checkboxDisabled = checkboxOpts.checkMethod && !checkboxOpts.checkMethod({ $table: $xeTable, row });
                    break;
                  case "radio":
                    cellValue = toBooleanValue($xeTable.isCheckedByRadioRow(row));
                    item2._radioLabel = radioOpts.labelField ? import_xe_utils22.default.get(row, radioOpts.labelField) : "";
        ...
        columns.forEach((column, $columnIndex) => {
          ...
          if (bodyExportMethod) {
            ...
            switch (column.type) {
              ...
              case "checkbox":
                cellValue = toBooleanValue($xeTable.isCheckedByCheckboxRow(row));
                item._checkboxLabel = checkboxOpts.labelField ? import_xe_utils22.default.get(row, checkboxOpts.labelField) : "";
                item._checkboxDisabled = checkboxOpts.checkMethod && !checkboxOpts.checkMethod({ $table: $xeTable, row });
                break;
              case "radio":
                cellValue = toBooleanValue($xeTable.isCheckedByRadioRow(row));
                item._radioLabel = radioOpts.labelField ? import_xe_utils22.default.get(row, radioOpts.labelField) : "";
    ...
    const getFooterCellValue = (opts, row, column) => {
      ...
      if (import_xe_utils22.default.isArray(row)) {
        return import_xe_utils22.default.toValueString(row[_columnIndex]);
      }
      return import_xe_utils22.default.get(row, column.field);
    };
    ...
    const hasEllipsis = (column, property, allColumnOverflow) => {
      ...
      const headOverflow = import_xe_utils22.default.isUndefined(columnOverflow) || import_xe_utils22.default.isNull(columnOverflow) ? allColumnOverflow : columnOverflow;
      const showEllipsis = headOverflow === "ellipsis";
      const showTitle = headOverflow === "title";
      const showTooltip = headOverflow === true || headOverflow === "tooltip";
        ...
        if (isColgroup && !original) {
          colgroups.forEach((cols) => {
            tables.push(`<tr>${cols.map((column) => {
              ...
              let childWidth = 0;
              let countChild = 0;
              import_xe_utils22.default.eachTree([column], (item) => {
      ...
      if (VxeUI.saveFile) {
        VxeUI.saveFile({ filename, type, content }).then(() => {
          if (opts.message !== false) {
            if (VxeUI.modal) {
              VxeUI.modal.message({ content: getI18n13("vxe.table.expSuccess"), status: "success" });
            }
          }
        });
      }
    ...
    const handleImport = (content, opts) => {
      ...
      if (status) {
        $xeTable.createData(rows).then((data) => {
          ...
          if (opts.message !== false) {
            if (VxeUI.modal) {
              VxeUI.modal.message({ content: getI18n13("vxe.table.impSuccess", [rows.length]), status: "success" });
            }
          }
        ...
        if (VxeUI.modal) {
          VxeUI.modal.message({ content: getI18n13("vxe.error.impFields"), status: "error" });
        }
        if (_importReject) {
    ...
    const handleFileImport = (file, opts) => {
      ...
      const importOpts = computeImportOpts.value;
      if (!importMethod && !import_xe_utils22.default.includes(import_xe_utils22.default.keys(importOpts._typeMaps), type)) {
        if (opts.message !== false) {
          if (VxeUI.modal) {
            VxeUI.modal.message({ content: getI18n13("vxe.error.notType", [type]), status: "error" });
          }
        }
        const params = { status: false };
        return Promise.reject(params);
    ...
    const handleFilterColumns = (exportOpts, column, columns) => {
      return columns.some((item) => {
        ...
        } else if (import_xe_utils22.default.isString(item)) {
    ...
    const handleFilterFields = (exportOpts, column, includeFields, excludeFields) => {
      if (excludeFields) {
        if (import_xe_utils22.default.includes(excludeFields, column.field)) {
          return false;
        }
      }
      if (includeFields) {
        if (import_xe_utils22.default.includes(includeFields, column.field)) {
          return true;
        }
        return false;
      }
    ...
    const handleExportAndPrint = (options, isPrint) => {
      ...
      const types = defOpts.types || import_xe_utils22.default.keys(exportOpts._typeMaps);
      ...
      const typeList = types.map((value) => {
        return {
          value,
          label: getI18n13(`vxe.export.types.${value}`)
        };
      });
      const modeList = modes.map((item) => {
        ...
        return {
          value: item,
          label: getI18n13(`vxe.export.modes.${item}`)
        };
      });
      import_xe_utils22.default.eachTree(exportColumns, (column, index, items, path, parent) => {
        const isColGroup = column.children && column.children.length;
        let isChecked = false;
        if (columns && columns.length) {
      ...
      if (filename) {
        if (import_xe_utils22.default.isFunction(filename)) {
      ...
      if (sheetName) {
        if (import_xe_utils22.default.isFunction(sheetName)) {
    ...
    const exportMethods = {
      ...
      exportData(options) {
        ...
        const customCols = columns && columns.length ? columns : import_xe_utils22.default.searchTree(collectColumn, (column) => {
          const isColGroup = column.children && column.children.length;
          let isChecked = false;
          if (columns && columns.length) {
        ...
        if (customCols) {
          ...
          groups = import_xe_utils22.default.searchTree(import_xe_utils22.default.mapTree(customCols, (item) => {
            let targetColumn;
            if (item) {
              if (isColumnInfo(item)) {
                targetColumn = item;
          ...
          groups = import_xe_utils22.default.searchTree(isGroup ? collectColumn : tableFullColumn, (column, index) => column.visible && (!columnFilterMethod || columnFilterMethod({ $table: $xeTable, column, $columnIndex: index })), { children: "children", mapChildren: "childNodes", original: true });
        }
        const cols = [];
        import_xe_utils22.default.eachTree(groups, (column) => {
          const isColGroup = column.children && column.children.length;
          if (!isColGroup) {
            cols.push(column);
          }
        ...
        if (!handleOptions.filename) {
          handleOptions.filename = getI18n13(handleOptions.original ? "vxe.table.expOriginFilename" : "vxe.table.expFilename", [import_xe_utils22.default.toDateString(Date.now(), "yyyyMMddHHmmss")]);
        }
        if (sheetName) {
          if (import_xe_utils22.default.isFunction(sheetName)) {
        ...
        if (!handleOptions.exportMethod && !import_xe_utils22.default.includes(import_xe_utils22.default.keys(exportOpts._typeMaps), type)) {
          errLog("vxe.error.notType", [type]);
          if (true) {
        ...
        if (!handleOptions.data) {
          ...
          if (mode === "selected") {
            if (["html", "pdf"].indexOf(type) > -1 && treeConfig) {
              handleOptions.data = import_xe_utils22.default.searchTree($xeTable.getTableData().fullData, (item) => $xeTable.findRowIndexOf(selectRecords, item) > -1, Object.assign({}, treeOpts, { data: "_row" }));
            } else {
            ...
            if ($xeGrid && !handleOptions.remote) {
              ...
              if (ajaxMethods) {
                ...
                return Promise.resolve((beforeQueryAll || ajaxMethods)(params)).then((rest) => {
                  const listProp = resConfigs.list;
                  handleOptions.data = (listProp ? import_xe_utils22.default.isFunction(listProp) ? listProp({ data: rest, $grid: $xeGrid }) : import_xe_utils22.default.get(rest, listProp) : rest) || [];
                  if (afterQueryAll) {
      ...
      importData(options) {
        const importOpts = computeImportOpts.value;
        const opts = Object.assign({
          types: import_xe_utils22.default.keys(importOpts._typeMaps)
      ...
      openImport(options) {
        ...
        if (isTree) {
          if (defOpts.message) {
            if (VxeUI.modal) {
              VxeUI.modal.message({ content: getI18n13("vxe.error.treeNotImp"), status: "error" });
            }
          }
          return;
        }
        ...
        const modeList = modes.map((item) => {
          ...
          return {
            value: item,
            label: getI18n13(`vxe.import.modes.${item}`)
          };
        });
      ...
      openExport(options) {
        ...
        const defOpts = Object.assign({
          message: true,
          types: import_xe_utils22.default.keys(exportOpts._typeMaps)
        }, exportOpts, options);
...
var browseObj = import_xe_utils23.default.browse();
function getTargetOffset(target, container) {
  ...
  if (triggerCheckboxLabel) {
    ...
    offsetTop -= import_xe_utils23.default.toNumber(checkboxLabelStyle.paddingTop);
    offsetLeft -= import_xe_utils23.default.toNumber(checkboxLabelStyle.paddingLeft);
  }
  while (target && target !== container) {
    ...
    if (triggerCheckboxLabel) {
      ...
      offsetTop -= import_xe_utils23.default.toNumber(checkboxStyle.paddingTop);
      offsetLeft -= import_xe_utils23.default.toNumber(checkboxStyle.paddingLeft);
    }
  }
  ...
  setupTable($xeTable) {
    ...
    const keyboardMethods = {
      ...
      moveCurrentRow(isUpArrow, isDwArrow, evnt) {
        ...
        if (currentRow) {
          if (treeConfig) {
            const { index, items } = import_xe_utils23.default.findTree(afterFullData, (item) => item === currentRow, { children: childrenField });
...
var { getConfig: getConfig7, validators: validators2, hooks: hooks9 } = VxeUI;
var Rule = class {
  constructor(rule) {
    Object.assign(this, {
      $options: rule,
  ...
  setupTable($xeTable) {
    ...
    const beginValidate = (rows, cols, cb, isFull) => {
      ...
      if (rows === true) {
        ...
        if (import_xe_utils24.default.isFunction(rows)) {
          cb = rows;
        } else {
          validList = import_xe_utils24.default.isArray(rows) ? rows : [rows];
        }
      }
      if (!validList) {
      ...
      if (editRules) {
        ...
        const handleVaild = (row) => {
          ...
          if (isFull || !validRuleErr) {
            const colVailds = [];
            columns.forEach((column) => {
              const field = import_xe_utils24.default.isString(column) ? column : column.field;
              if ((isFull || !validRuleErr) && import_xe_utils24.default.has(editRules, field)) {
        ...
        if (treeConfig) {
          import_xe_utils24.default.eachTree(validList, handleVaild, { children: childrenField });
        } else {
            ...
            const finish = () => {
              nextTick(() => {
                if (cb) {
                  ...
                  if (getConfig7().validToReject === "obsolete") {
                    reject(validRest);
                  } else {
                    resolve(validRest);
                  }
    ...
    validatorMethods = {
      ...
      fullValidate(rows, cb) {
        if (true) {
          if (import_xe_utils24.default.isFunction(cb)) {
      ...
      fullValidateField(rows, fieldOrColumn) {
        const colList = (import_xe_utils24.default.isArray(fieldOrColumn) ? fieldOrColumn : fieldOrColumn ? [fieldOrColumn] : []).map((column) => handleFieldOrColumn($xeTable, column));
        if (colList.length) {
      ...
      clearValidate(rows, fieldOrColumn) {
        ...
        const validTip = refValidTooltip.value;
        const validOpts = computeValidOpts.value;
        const rowList = import_xe_utils24.default.isArray(rows) ? rows : rows ? [rows] : [];
        const colList = (import_xe_utils24.default.isArray(fieldOrColumn) ? fieldOrColumn : fieldOrColumn ? [fieldOrColumn] : []).map((column) => handleFieldOrColumn($xeTable, column));
        let validErrMaps = {};
        if (validTip && validTip.reactData.visible) {
          validTip.close();
        ...
        if (rowList.length && colList.length) {
          ...
          import_xe_utils24.default.each(validErrorMaps, (item, key) => {
    ...
    const validErrorRuleValue = (rule, val) => {
      ...
      const numVal = isNumType ? import_xe_utils24.default.toNumber(val) : import_xe_utils24.default.getSize(val);
      if (isNumType && isNaN(val)) {
        return true;
      }
      if (!import_xe_utils24.default.eqNull(min) && numVal < import_xe_utils24.default.toNumber(min)) {
        return true;
      }
      if (!import_xe_utils24.default.eqNull(max) && numVal > import_xe_utils24.default.toNumber(max)) {
        return true;
      }
      if (pattern && !(import_xe_utils24.default.isRegExp(pattern) ? pattern : new RegExp(pattern)).test(val)) {
        return true;
      }
      return false;
    };
    validatorPrivateMethods = {
      ...
      validCellRules(validType, row, column, val) {
        ...
        const syncValidList = [];
        if (field && editRules) {
          const rules = import_xe_utils24.default.get(editRules, field);
          if (rules) {
            const cellValue = import_xe_utils24.default.isUndefined(val) ? import_xe_utils24.default.get(row, field) : val;
            rules.forEach((rule) => {
              ...
              if (validType === "all" || !trigger || validType === trigger) {
                if (validator) {
                  ...
                  let customValid;
                  if (import_xe_utils24.default.isString(validator)) {
                  ...
                  if (customValid) {
                    if (import_xe_utils24.default.isError(customValid)) {
                      validRuleErr = true;
                  ...
                  const isArrVal = import_xe_utils24.default.isArray(cellValue);
                  let hasEmpty = true;
                  if (isArrType || isArrVal) {
                    hasEmpty = !isArrVal || !cellValue.length;
                  } else if (import_xe_utils24.default.isString(cellValue)) {
      ...
      hasCellRules(type, row, column) {
        ...
        if (field && editRules) {
          const rules = import_xe_utils24.default.get(editRules, field);
          return rules && !!import_xe_utils24.default.find(rules, (rule) => type === "all" || !rule.trigger || type === rule.trigger);
        }
        return false;
      },
      /**
  ...
  setupTable($xeTable) {
    ...
    const handleUpdateCustomColumn = () => {
      ...
      if (customStore.visible) {
        ...
        const fixedMaps = {};
        const visibleMaps = {};
        import_xe_utils25.default.eachTree(collectColumn, (column) => {
    ...
    const saveCustom = () => {
      ...
      import_xe_utils25.default.eachTree(customColumnList, (column, index, items, path, parentColumn) => {
        if (parentColumn) {
          column.fixed = parentColumn.fixed;
        } else {
          if (allowSort) {
    ...
    const cancelCustom = () => {
      ...
      const customOpts = computeCustomOpts.value;
      const { allowVisible, allowSort, allowFixed, allowResizable } = customOpts;
      import_xe_utils25.default.eachTree(customColumnList, (column) => {
        const colid = column.getKey();
...
var { getConfig: getConfig8, renderer: renderer12, getI18n: getI18n14, getComponent } = VxeUI;
var componentDefaultModelProp = "modelValue";
var defaultCompProps = {};
function handleDefaultValue(value, defaultVal, initVal) {
  return import_xe_utils26.default.eqNull(value) ? import_xe_utils26.default.eqNull(defaultVal) ? initVal : defaultVal : value;
}
function parseDate(value, props) {
  return value && props.valueFormat ? import_xe_utils26.default.toStringDate(value, props.valueFormat) : value;
}
function getFormatDate(value, props, defaultFormat) {
  const { dateConfig = {} } = props;
  return import_xe_utils26.default.toDateString(parseDate(value, props), dateConfig.labelFormat || defaultFormat);
}
function getLabelFormatDate(value, props) {
  return getFormatDate(value, props, getI18n14(`vxe.input.date.labelFormat.${props.type || "date"}`));
}
...
function getCellEditProps(renderOpts, params, value, defaultProps) {
  return import_xe_utils26.default.assign({ immediate: getInputImmediateModel(renderOpts) }, defaultCompProps, defaultProps, renderOpts.props, { [componentDefaultModelProp]: value });
}
...
function getFilterOns(renderOpts, params, option) {
  return getComponentOns(renderOpts, params, {
    ...
    change() {
      handleConfirmFilter(params, !import_xe_utils26.default.eqNull(option.data), option);
    },
    blur() {
      handleConfirmFilter(params, !import_xe_utils26.default.eqNull(option.data), option);
    }
...
function handleFilterMethod({ option, row, column }) {
  const { data } = option;
  const cellValue = import_xe_utils26.default.get(row, column.field);
  return cellValue == data;
}
function handleInputFilterMethod({ option, row, column }) {
  const { data } = option;
  const cellValue = import_xe_utils26.default.get(row, column.field);
  return import_xe_utils26.default.toValueString(cellValue).indexOf(data) > -1;
}
...
function getSelectCellValue(renderOpts, { row, column }) {
  ...
  if (!(cellValue === null || cellValue === void 0)) {
    return import_xe_utils26.default.map(import_xe_utils26.default.isArray(cellValue) ? cellValue : [cellValue], optionGroups ? (value) => {
      const groupOptions = optionGroupProps.options || "options";
      for (let index = 0; index < optionGroups.length; index++) {
        selectItem = import_xe_utils26.default.find(optionGroups[index][groupOptions], (item) => item[valueProp] == value);
        if (selectItem) {
          break;
        }
      }
      ...
      selectItem = import_xe_utils26.default.find(options, (item) => item[valueProp] == value);
      return selectItem ? selectItem[labelProp] : value;
    }).join(", ");
  }
  return "";
...
function getTreeSelectCellValue(renderOpts, { row, column }) {
  ...
  if (!(cellValue === null || cellValue === void 0)) {
    const keyMaps = {};
    import_xe_utils26.default.eachTree(options, (item) => {
      keyMaps[import_xe_utils26.default.get(item, valueProp)] = item;
    }, { children: childrenProp });
    return import_xe_utils26.default.map(import_xe_utils26.default.isArray(cellValue) ? cellValue : [cellValue], (value) => {
      const item = keyMaps[value];
      return item ? import_xe_utils26.default.get(item, labelProp) : item;
    }).join(", ");
  }
  return "";
}
...
function handleNumberCell(renderOpts, params) {
  ...
  const { row, column } = params;
  const { type } = props;
  let cellValue = import_xe_utils26.default.get(row, column.field);
  let isNegative = false;
  if (!isEmptyValue(cellValue)) {
    const numberInputConfig = getConfig8().numberInput || {};
    if (type === "float") {
      const autoFill = handleDefaultValue(props.autoFill, numberInputConfig.autoFill, true);
      const digits = handleDefaultValue(props.digits, numberInputConfig.digits, 1);
      cellValue = import_xe_utils26.default.toFixed(import_xe_utils26.default.floor(cellValue, digits), digits);
      if (!autoFill) {
        cellValue = import_xe_utils26.default.toNumber(cellValue);
      }
      ...
      cellValue = import_xe_utils26.default.commafy(cellValue, { digits });
      if (!autoFill) {
      ...
      if (showCurrency) {
        cellValue = `${props.currencySymbol || numberInputConfig.currencySymbol || getI18n14("vxe.numberInput.currencySymbol") || ""}${cellValue}`;
      }
    } else {
      if (showNegativeStatus) {
        if (import_xe_utils26.default.toNumber(cellValue) < 0) {
          isNegative = true;
        }
      }
    }
...
renderer12.mixin({
  ...
  VxeInput: {
    ...
    renderTableCell(renderOpts, params) {
      ...
      const { row, column } = params;
      const inputConfig = getConfig8().input || {};
  ...
  VxeNumberInput: {
    ...
    renderTableFooter(renderOpts, params) {
      ...
      const { type } = props;
      const itemValue = import_xe_utils26.default.isArray(row) ? row[_columnIndex] : import_xe_utils26.default.get(row, column.field);
      if (import_xe_utils26.default.isNumber(itemValue)) {
        const numberInputConfig = getConfig8().numberInput || {};
        if (type === "float") {
          const autoFill = handleDefaultValue(props.autoFill, numberInputConfig.autoFill, true);
          const digits = handleDefaultValue(props.digits, numberInputConfig.digits, 1);
          let amountLabel = import_xe_utils26.default.toFixed(import_xe_utils26.default.floor(itemValue, digits), digits);
          if (!autoFill) {
            amountLabel = import_xe_utils26.default.toNumber(amountLabel);
          }
          return amountLabel;
        } else if (type === "amount") {
          const autoFill = handleDefaultValue(props.autoFill, numberInputConfig.autoFill, true);
          const digits = handleDefaultValue(props.digits, numberInputConfig.digits, 2);
          const showCurrency = handleDefaultValue(props.showCurrency, numberInputConfig.showCurrency, false);
          let amountLabel = import_xe_utils26.default.commafy(import_xe_utils26.default.toNumber(itemValue), { digits });
          if (!autoFill) {
          ...
          if (showCurrency) {
            amountLabel = `${props.currencySymbol || numberInputConfig.currencySymbol || getI18n14("vxe.numberInput.currencySymbol") || ""}${amountLabel}`;
          }
          return amountLabel;
        }
      }
  ...
  $input: {
    ...
    renderTableCell(renderOpts, params) {
      ...
      const { props = {} } = renderOpts;
      const { row, column } = params;
      const digits = props.digits || ((_a = getConfig8().input) === null || _a === void 0 ? void 0 : _a.digits) || 2;
      let cellValue = import_xe_utils26.default.get(row, column.field);
      if (cellValue) {
        switch (props.type) {
          case "date":
